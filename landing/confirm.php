...
<form action="send_mail.php" method="post" id="frm_confirm" enctype="multipart/form-data">
<?php
echo $prev_input;
echo $prev_input1;
echo $prev_radio;
...
<div class="form-personal-profile">
    ...
    <div class="table-personal-profile">
        <table>
            ...
            <tr>
                <td class="label">
                    <div>職務内容を入力または経歴書を添付<br/>※ファイル名は半角英数</div>
                </td>
                <td>
                    <div class="td-content">
...
<div class="form-personal-profile">
    ...
    <div class="table-personal-profile">
        <table>
		 ...
		 <?php if(!empty($_POST['text21']) || !empty($_POST['select13']) || !empty($_POST['select14']) ): ?>
            <tr>
                <td class="label">
                    <div><?php echo $_POST['select12'] ?></div>
                </td>
                <td>
                    ...
                    <div class="td-content clear">
                        <div class="clear"><?php echo $_POST['select14']; ?></div>
                    </div>
                </td>
            </tr>
			<?php endif; ?>
