...
$errorfileortext='入力テキストを入力するか、ファイルをアップロードしてください。';
    ...
    jQuery(document).ready(function ($) {
		...
		else
		{
			...
			else 
			{
				 ...
				 $('#select11').removeClass('bg_error_fx');
				 $("#errorselect11").empty();
            }
		...
		if ($re9 == true && $re10 == true && $re11 == true){
           ...
           // var email2 = $('#text9').val();
			...
			if ($('#text14').val() == ''){
				...
				$('#text14').addClass('bg_error_fx');
                $re13 = false;
            }else{
				$(this).find('#text14').removeClass('textError');
				$('#text14').removeClass('bg_error_fx');
				$("#errortext14").empty();
                $re13 = true;
            }
            ...
            if ($('#text10').val() == ''){
                ...
                $('#text10').addClass('bg_error_fx');
                $re15 = false;
            }else{
                $(this).find('#text10').removeClass('textError');
                $('#text10').removeClass('bg_error_fx');
                $("#errortext10").empty();
                $re15 = true;
            }
            if ($('#text17').val() == ''){
                $('#errortext17').text($errorText);
                $('#errortext17').addClass('error');
                $(this).find('#text17').addClass('textError');
                $('#text17').addClass('bg_error_fx');
                $re16 = false;
            }else{
                $(this).find('#text10').removeClass('textError');
                $('#text17').removeClass('bg_error_fx');
                $("#errortext17").empty();
                $re16 = true;
            }
            ...
            if ($('#file1').val()!='' || $('#file2').val()!='' || $('#text18').val() != '')
            {
                $(this).find('#file1').removeClass('textError');
                $(this).find('#file2').removeClass('textError');
                ...
                $('#file_text18').text($errorfileortext);
                $('#file_text18').addClass('error');
                $(this).find('#file1').addClass('textError');
                $(this).find('#file2').addClass('textError');
            ...
            if ($re1 == false || $re2 == false || $re3 == false || $re4 == false || $re5 == false || $re6 == false || $re7 == false || $re8 == false || $re9 == false || $re10 == false || $re11 == false || $re12 == false) {
                ...
                scroll_top_by_id(personal_block2);
                return false;
            }else if($re13 == false || $re16 == false){
				scroll_top_by_id(personal_block3);
				return false;
			}else if($re17 == false || $re18 == false){
