...
<head>
    ...
    <meta name="keywords" content="ヘッドハンティング,人材紹介会社,転職エージェント,キャリアコンサルティング,クライス&カンパニー,30代,コンサルタント,エンジニア,キャリアデザイン,転職サポート,エントリー,簡単" />
...
?>
    <div style="margin:0 0 5px;">転職に関するご相談、企業のご紹介など費用は全て無料ですので、ご安心下さい。</div>
            ...
            <tr>
                ...
                <td colspan="2">
                    <div class="td-content clear">
                        ...
                        <div style="width: 70px;  margin: 3px 0 0 0">&nbsp;※確認用</div>
...
<!----------------------************************--------------------------->
  ...
  <div class="form-personal-profile step_hiden">
    <div class="table-personal-profile">  
            ...
            <tr>
                <td class="label">
                    <div>経歴書を添付<span class="red-color">(必須）</span><br /><span class="normal">※ファイル名は半角英数</span></div>
                </td>
                <td>
                <div style="float:left; width:250px;">
                    ...
                    <div style="margin:5px 10px; font-size:11px; line-height:15px;" class="clear">
...
<div class="form-personal-profile step_hiden">
    <div class="table-personal-profile">
        <table>
            <tr>
                <td class="label">
                    <div>何をご覧になって<br />アクセス頂きましたか？</div>
                </td>
                <td>
                    <div class="td-content clear">
                    <div>
            ...
            <tr>
                ...
                <td>
                    <div class="td-content clear">
                        <div><textarea style="width: 400px; margin-bottom: 0px" TYPE="text" name="text14" id="text14" onFocus="click_text(this.id)"
                                    value=""></textarea></div>
                        <div style="margin:0px 10px; font-size:11px; line-height:15px;" class="clear">※具体的にご紹介された弊社コンサルタントがおりましたらお手数ですが下記よりご選択ください。</div>
                    </div>
                     <div class=" td-content clear">
                     <div>
                         <select class="selection" style="width: 300px" name="select7" id="select7">
                                        ...
                                        <option value="越山 恵理">越山 恵理</option>
...
<div class="form-personal-submit next_step clear">
    <!--    <div class="form-back"><a href="#" title="Back"><img src="../img/entry/button-back.png" alt=""> </a></div>-->
     <input class="button-back_step" type="button" name="submit_back" id="back_step_go" value="Next Step"/>
     <input class="button-confirm_btn" type="submit" name="submit" id="submit_confirm" value="2"/>
...
<footer>
    <div id="main-footer">
        <div id="footer" class="clear">
            <div class="copy">
                Copyright &copy;2013 KREIS &amp; Company Inc. All Right Reserved. webdesign tokyodesignroom.com
            </div>
        </div>
    </div>
</footer>
