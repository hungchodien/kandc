		...
		if ($re9 == true && $re10 == true && $re11 == true){
           ...
           // var email2 = $('#text9').val();
			...
			else 
			{
				 ...
				 $('#select6').removeClass('bg_error_fx');
				 $("#errorselect6").empty();
            }
            ...
            if ($re1 == false || $re2 == false || $re3 == false || $re4 == false || $re5 == false || $re6 == false || $re7 == false || $re8 == false || $re9 == false || $re10 == false || $re11 == false || $re12 == false || $re18 == false) {
