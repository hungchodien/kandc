...
<form action="confirm.php" method="post" id="submit_form" enctype="multipart/form-data" encoding="multipart/form-data">
		...
		<table>
	        <tr>
		        <td class="label">
		         ...
		         <td class="pd10">
		             <textarea id="text22" value="" name="text22" type="text" style="width: 580px; " cols="50" rows="5" onfocus="click_text(this.id)"></textarea>
		         </td>
	        </tr>
        </table>
	</div>
            ...
            <tr>
                ...
                <td class="pd10">
                    <div class="td-content clear line_auto" style="position:relative;">
                        <div>
                            <input class="text-personal-400 bg_error_fx" onblur="validatetext(this.value, this.id)" type="text" name="text8" id="text8" placeholder="（例）example@kandc.com" onfocus="click_text_error(this.id)"/>
    ...
    <div class="table-personal-profile">
        <table>
            <tr>
                ...
                <td>
                    <div class="td-content clear" style="position:relative;">
                        <div><input type="text" name="text10" id="text10" placeholder="（例）◯◯大学　◯◯学部　◯◯学科" class="bg_error_fx" value="" style="width:580px;" onblur="validatetext(this.value, this.id)" onfocus="click_text(this.id)"/>
                        <p id="errortext10" class="error_box10"></p>
                        </div>
...
<div class="table-personal-profile">
    <table>
        <tr>
            ...
            <td>
                <div class="td-content clear" style="position:relative;">
                    <div><input type="text" class="text-personal-400 bg_error_fx" placeholder="（例）株式会社◯◯" name="text13" id="text13" value="" onblur="validatetext(this.value, this.id)" onfocus="click_text_error(this.id)"/>
...
<tr>
    <td class="label">
        <div>業種<span class="red-color">(必須）</span></div>
    </td>
    <td>
        <div class="td-content clear" style="position:relative;">
            <div>
                <select class="selection bg_error_fx" style="width: 250px" name="select6" id="select6" onblur="validateSelect(this.value, this.id)" onfocus="click_text(this.id)">
                ...
                <p id="errorselect6" class="error_box6"></p>
            </div>
    ...
    <td>
        <div class="td-content clear" style="position:relative;">
            <div>
                ...
                <p id="errorselect11" class="error_box11"></p>
            </div>
...
<tr>
    ...
    <td>
        <div class="td-content clear">
            <div><input style="width: 400px; margin-bottom: 10px" type="text" name="text16" placeholder="（例）マーケティング部　課長" id="text16" value="" onfocus="click_text(this.id)"/></div>
...
<tr>
    <td class="label">
        <div>職務内容 <span class="red-color">(必須）</span></div>
    </td>
    <td>
        <div class="td-content clear" style="position:relative;">
