...
<!--  the start page navi --->
        ...
        <div id="related-employ" class="related-employ">
            <div class="related-employ-title clear">
                ...
                <h2><?php echo "[".$row_list_job[0]."]"; ?> <a href="<?php echo url_root; ?>jobinfo/<?php echo $row_list_job[0]; ?>/<?php echo $category_id.".html"; ?>" onclick="Load_Job(<?php echo $row_list_job[0]; ?>)"><?php echo $row_list_job[22]; ?></a> </h2>
                <?php 
								if ($row_list_job[1]==1)
								{
            ...
            <div class="related-employ-duty clear">
                <table class="related-table">
                    <tr class="related-duty">
                        ...
                        <td><?php echo  $row_list_job[30]; ?><?php echo  $row_list_job[31]; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="related-colspan-3" colspan="3"><?php echo $row_list_job[24]."<br/>".$row_list_job[25]; ?>
                        </td>
                    </tr>
                </table>
                <div class="ct-readmore1 clear readmore_index">
                    <!--<input type="button" name="duty" class="button-duty" value="" onclick="window.location.href='<?php echo url_root; ?>jobinfo/<?php echo $row_list_job[0]; ?>/<?php echo $row_list_job['category_id'].".html"; ?>'"/>-->
