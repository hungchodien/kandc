                    ...
                    <ul class="list_item_blog clear">
                    	<?php 
							...
							$j=$i+1;
								...
								$blog_date_d=(int)date('d', strtotime($List_blog['kc_blog_date']));
								$blog_date_m=(int)date('m', strtotime($List_blog['kc_blog_date']));
								$blog_date_y=(int)date('Y', strtotime($List_blog['kc_blog_date']));
