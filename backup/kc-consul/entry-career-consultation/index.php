   ...
   <link type="text/css" href="style.css" rel="stylesheet"/>
	<script type="text/javascript">
		...
		if (isMobile.matches) 
			{
				//	alert("mobile");
				document.location = "https://www.kandc.com/mobile/entry-career-consultation/";
			}
    ...
    <?php //@include("../config.php"); ?>
       ...
       <div class="header_top clear">
        ...
        <div class="header_logo clear">
			...
			echo url_root."entry_easy/?entry_id=1014585";?>" target="_blank"><img src="<?php echo url_root; ?>img/entry/entry-easy-button.png" alt="まずは気軽に相談する" /></a>--></div>
            </div>
        </div><!--End .header_logo-->
    	...
    	<table class="no_bb">
	        <tr>
		        <td class="label">
		         ...
		         <td class="pd10">
		             <textarea id="text18" value="" name="text18" type="text" style="width: 580px; " cols="50" rows="5" onfocus="click_text(this.id)"></textarea>
		         </td>
	        </tr>
        </table>
                ...
                <td class="pd10">
                    <div class="td-content phone clear " >
                       <div style="position:relative;">
                            <input class="phone_require bg_error_fx" onblur="validatetext(this.value, this.id)" type="text" name="text5" id="text5" value="" style="-webkit-ime-mode:inactive;-moz-ime-mode:inactive;-ms-ime-mode:inactive;ime-mode:inactive; margin-left: 0px;" onfocus="click_text_error(this.id)"/> -
...
<div class="table-personal-profile">
    <table>
    	<tr>
            ...
            <td>
                <div class="td-content clear" style="position:relative;">
                    <div><input type="text" class="bg_error_fx" name="text14" id="text14" value="" onblur="validatetext(this.value, this.id)" onfocus="click_text_error(this.id)"  placeholder="（例）株式会社○○"/>
