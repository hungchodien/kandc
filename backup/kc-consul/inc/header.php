		...
		$( document ).ready(function() {
			...
			<?php
				...
				//echo $url_check_set_tbl;
					...
					{
	$('#interview_content_left').append("<div class='interview_entry_btn interview_hide_add'><a target='_blank' href='<?php echo $url_entry_link; ?>'><img title=' ' alt=' ' src='<?php echo url_root; ?>img/entry/company-id-button.png'></a></div>");				
					}
					else
					{
	...
	?>
        ...
        <div class="header_logo clear">
            ...
            <div class="l">
                ...
                <a class="entry_tbl_kc" href="<?php	echo url_root; ?>entry-career-consultation/?entry_id=1014585" target="_blank"><img src="<?php echo url_root; ?>img/entry/head-entry-button-v2.png" alt="まずは気軽に転職相談する" /></a></div>
            </div>
        </div><!--End .header_logo-->
