...
?>" class="entry_tbl_kc" target="_blank">
                <img src="<?php echo url_root; ?>img/entry/sidebar-entry-button-v2.png" alt="業界出身のコンサルに転職・キャリア支援を申し込む" />
                </a>
                </div><!--btl_entry_easy-->
             ...
             <div class="title-link clear">
             	<div class="clear group_feature_sidebar">
					...
					<a class="features_a" target="_top" href="<?php echo url_root; ?>about-us.html" ></A>
                </div>
             </div><!--title-link-->
            ...
            <div class="title-link group_entry_easy clear career_consultant_sidebar_group">
            	<div class="clear career_consultant_gr1">
	            	<div class="clear career_consultant_sidebar">
	                	<div class="l"><a target="_top" href="<?php echo url_root; ?>about-us.html#consultant_part17" ><img src="<?php echo url_root ?>img/home/sidebar-consultant-irie.png" alt="シニアコンサルタント 入江 祥之"/></a></div>
	                    <div class="l">
	                    	<div class="clear group_title_career_consultant">
                            	<a target="_top" href="<?php echo url_root; ?>about-us.html#consultant_part17" >
	                        	<h4>シニアコンサルタント</h4>
	                            <h3>入江 祥之</h3>
                             	</a>
	                        </div>
                ...
                <div class="clear career_consultant_gr2">
	            	<div class="clear career_consultant_sidebar">
	                	<div class="l"><a target="_top" href="<?php echo url_root; ?>about-us.html#consultant_part25" ><img src="<?php echo url_root ?>img/home/sidebar-consultant-nagata.png" alt="チーフコンサルタント 永田 憲章"/></a></div>
	                    <div class="l">
	                    	<div class="clear group_title_career_consultant">
                            	<a target="_top" href="<?php echo url_root; ?>about-us.html#consultant_part25" >
	                        		<h4>チーフコンサルタント</h4>
	                           	 	<h3>永田 憲章</h3>
                               </a>
	                        </div>
                ...
                <div class="clear link_career_consultant_ft">
                	<div class="r">
	                	<a target="_top" href="<?php echo url_root; ?>about-us.html#consultant_part" class="read_more_career_consultant_sidebar">
	                    	<span>コンサルタント紹介</span>
             ...
             <div class="title-link group_entry_easy clear policy_sidebar">
                    ...
                    <div class="clear policy_sidebar_readmore">
	                	<div class="r">
		                	<a target="_top" href="<?php echo url_root; ?>about-us.html#policy_part" class="read_more_career_consultant_sidebar">
		                    	<span>サービス理念</span>
		                        <span class="next_btn"></span>
		                    </a>
	                    </div>
             ...
             <div class="title-link group_entry_easy clear blog_sidebar">
               ...
               <div class="clear blog_sidebar_content"> 
                <div class="clear blog_item_sidebar">
	                		<h3 class="title"><a href="<?php echo url_root; ?>blog/post_011.html">コンサルが経営者になるためのヒント その2</a></h3>
	                            <div class="clear date_blog_sidebar">
	                            	<span>2015年11月9日・入江 祥之</span>
	                        </div>
                              </div>
               <div class="clear blog_item_sidebar">
	                		<h3 class="title"><a href="<?php echo url_root; ?>blog/post_010.html">Alumni Partyで感じたファームで働く魅力</a></h3>
	                            <div class="clear date_blog_sidebar">
	                            	<span>2015年10月26日・永田 憲章</span>
	                        </div></div>
               
               <div class="clear blog_item_sidebar">
	                		<h3 class="title"><a href="<?php echo url_root; ?>blog/post_009.html">コンサルが経営者になるためのヒント その1</a></h3>
	                            <div class="clear date_blog_sidebar">
	                            	<span>2015年10月13日・入江 祥之</span>
	                        </div></div>
