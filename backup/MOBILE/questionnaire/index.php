            ...
            <div class="bg_white content_inside block_content mobile_entry_question" >
                ...
                <div class="group_txt_form clear">
                 ...
                 <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                    	<div class="input_100">
                   		<p>
                        <textarea type="text" name="s8" id="s8"></textarea>
                        </p>
                         <p id="errorrs8"></p>
                        </div>
                    </div>
               ...
               <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                    	<div class="input_100">
                   		<p>
                         <input type="radio" name="s9" value="とても満足" id="l199_0">
 						 <label for="l199_0">とても満足</label>
						</p>
                        <p>
                        <input type="radio" name="s9" value="どちらかといえば満足"  id="l199_1">
 						<label for="l199_1">どちらかといえば満足</label>
                        </p>
                        <p>
                         <input type="radio" name="s9" value="普通" id="l199_2">
 						 <label for="l199_2">普通</label>
                         </p>
                         <p>
                         <input type="radio" name="s9" value="不満" id="l199_3">
                 ...
                 <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                    	<div class="input_100">
                   		<p>
                        <textarea type="text" name="s10" id="s10"></textarea>
                        </p>
                         <p id="errorrs10"></p>
                        </div>
                    </div>
