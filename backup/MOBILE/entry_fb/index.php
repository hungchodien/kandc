...
?>
    ...
    <script src="<?php echo url_root; ?>js/validate_form_entry.js" type="text/javascript"></script>
       ...
       <div class="title_notice clear">
       		<p class="title_top_form yellow clear">今すぐ転職をお考えのあなた</p>
            ...
            <div class="bg_white content_inside block_content">
             ...
             <div class="bg_white content_inside block_content">
                ...
                <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                        ...
                        <div class="input_20 r" style="display:none;">
             ...
             <div class="bg_white content_inside block_content">
                ...
                <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                    	<div class="input_40 l title_txt">
                       		経験社数<span class="notice">(必須）</span>
                        </div>
                        <div class="input_60 r">
                ...
                <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                        ...
                        <div class="input_5 l title_txt1">
                       	 ～
                        </div>
                    ...
                    <div class="input_radio_option radio clear">
                        	<div class="input_radio">
								<label><input type="radio"  name="radio1" value="現職中"/>現職中</label>
							</div>
							<div class="input_radio">
								<label><input type="radio" name="radio1" value="退職予定"/>退職予定</label>
							</div>
							<div class="input_radio">
								<label><input type="radio" name="radio1" value="離職中"/>離職中</label>
							</div>
                    </div> 
             ...
             <div class="bg_white content_inside block_content">
                 ...
                 <div class="group_txt_form clear">
                	<div class="clear input_form">
                    	<div class="input_20 title_txt l">
                    	媒体
                        </div>
                       <div class="input_80 r">
             ...
             <div class="block_content clear">
             	<div class="form_back_button button-back">
                	<a title="Back" href="javascript:history.back(1)">&lsaquo; 戻る</a>
                </div>
                <div class="submit_form_button">
               		 <input type="submit" value="内容確認に進む &rsaquo;" id="submit" name="Submit" class="button-confirm">
                </div>
