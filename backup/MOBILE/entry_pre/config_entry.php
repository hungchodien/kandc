<?php 
	/*********************************************************************/
			...
			$admin_subject="【HP-Entry_PreMobile】エントリーがありました。";
			$domain="https://kandc.com/mobile/entry_pre";
$user_content =
"{USER_NAME} 様\r\n
			
この度は当社にエントリーいただきまして、誠にありがとうございます。\r\n
			
ご入力いただきました情報を元に担当のコンサルタントを決めさせていただきます。<br>
担当が決まり次第コンサルタント、またはリサーチ部よりご連絡いたしますので、<br>
今しばらくお待ちください。\r\n
			
尚、ご年齢、ご経歴、ご希望によっては案件をご紹介<br>
できない場合もございますのでご了承ください。\r\n
			
いずれにしましても、必ずこちらからご連絡いたします。\r\n
			
※なお、履歴書・ご経歴書等をお送りいただけますと<br>
よりマッチした情報のご提供が可能です。<br>
こちらのアドレス宛に、直接お送りくださいませ。\r\n
...
------------------------------------------------\r\n
"."<br/>"."https://".$_SERVER['SERVER_NAME']."/entry_pre";
	/**********************************************************************/
