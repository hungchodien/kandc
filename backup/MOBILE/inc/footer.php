<div class="clear inside hide_in_mobile_forms" id="banner_exe">
<div class="clear block_content">
        <a target="_blank" href="http://kc-consul.com/">
            <img alt="コンサルタントのための転職サイト Consultant Career" src="<?php echo url_root_domain; ?>img/link/consultant-career-kreis-company-mobile-banner.png" style="width:100%;">
        </a>
        </div>
	<div class="clear block_content">
        <a target="_blank" href="<?php echo url_root_domain; ?>exe/">
            <img alt="エグゼクティブポジションでの転職をお考えの方はこちらから" src="<?php echo url_root_domain; ?>img/link/mobile_banner_exe.png" style="width:100%;">
        </a>
        </div>
        <div class="clear block_content">
        <a target="_blank" href="<?php echo url_root_domain; ?>academy/">
            <img alt="弊社主催のセミナー&amp;交流会 汐留アカデミー" src="<?php echo url_root_domain; ?>img/link/shiodome-academy-kreis-company-mobile-banner.png" style="width:100%;">
        </a>
    </div>
</div>

<div class="entry_btns inside hide_in_mobile_forms">
<h3 class="img_title"><img title="" alt="転職支援サービスを受ける" src="<?php echo url_root; ?>img/index/entry_title.png"></h3>
<a href="<?php echo url_root; ?>entry/"><img title="" alt="entry" src="<?php echo url_root; ?>img/index/entry_btn.png"></a>
<a href="<?php echo url_root; ?>entry_pre/"><img title="" alt="entry" src="<?php echo url_root; ?>img/index/entry_pre_btn.png"></a>
</div>
<div class="max_width hide_in_mobile_forms">
 <div class="foot_links clear">
 <ul class="fl">
 <li><a href="<?php echo url_root; ?>features/">当社の特長</a></li>
 <li><a href="<?php echo url_root; ?>jobinfo/">求人情報</a></li>
 <li><a href="<?php echo url_root; ?>entry/">今すぐ転職</a></li>
 <li><a href="<?php echo url_root; ?>profile/">会社概要</a></li>
 </ul>
 <ul class="fr">
 <li><a href="<?php echo url_root; ?>consultant/">キャリアコンサルタント</a></li>
 <li><a href="<?php echo url_root; ?>reading/">コラム・インタニュー</a></li>
 <li><a href="<?php echo url_root; ?>entry_pre/">いつかは転職</a></li>
 <li><a href="<?php echo url_root; ?>access/">アクセス</a></li>
 </ul>
 </div> 
 </div>
...
webdesign <a href="http://tokyodesignroom.com" title="tokyodesignroom website">tokyodesignroom.com</a></p>
