<div class="clear mailmagazine_inc_group" id="list_category_relead_post">
		<div class="clear mailmagazine_inc_list">
                    <div class="title_mailmagazine clear">
                        <div class="l"><img src="<?php echo url_root; ?>img/jobinfo/title-another-category.png" alt=""></div>
                        <div class="r"></div>
                    </div>
											...
											if($Data_parent['cnt'] > 0):
												echo "<ul class='clear parent_category_ul'>";
													...
													for($m=0; $m<$count_parent_cate; $m++):
														...
														$job_count_parent=Count_ListJob_ByCategory($id_parent);
											  ...
											  if($Data_chil['cnt'] > 0)
											  {
												 ...
												 for($j=0; $j<$count_chil_cate; $j++)
												 {
													...
													// echo "(&nbsp;".Count_ListJob_ByCategory($row_list['id']).")";
													 ...
													 $count_job_chil=Count_ListJob_ByCategory($id_chil);
