...
?>	
	<?php
		@include('set_user_ID_mobile_tab.php');
		@include('../set_user_ID_mobile_tab.php');
	    @include('../../set_user_ID_mobile_tab.php');
 		@include('../../../set_user_ID_mobile_tab.php');
		@include('../../../../set_user_ID_mobile_tab.php');
        ...
        for($k=1; $k<22;$k++):
			...
			To_Send_Mail($user_name, $user_email, $admin_email, $admin_subject, $body_content, $type="",$file_send_mail, $cc="", $bcc="", $charset="");				
		To_Send_Mail($admin_name, $admin_email, $user_email, $user_subject, $user_content, $type="",$file="", $cc="", $bcc="", $charset="");
		?>
          <script language="javascript">
   		 //window.location.href = 'complete.php?nameEbis=<?php echo $nameEbis ?>&emailEbis=<?php echo $emailEbis; ?>&birthdayEbis=<?php echo $date_birth; ?>&midEbis=<?php echo $entry_ID_userFix; ?>&pidEbis=landing-30_mobile';
