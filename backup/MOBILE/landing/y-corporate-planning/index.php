...
<meta name="keywords" content="ヘッドハンティング,人材紹介,転職エージェント,クライス&カンパニー,キャリアアップ" />
<meta name="description" content="クライス&カンパニーは、経営者・経営幹部を目指す方を専任キャリアコンサルタントがバックアップする人材紹介会社です。専属キャリアパートナーとお話をしたい方はぜひエントリーください。
" />


<meta PROPERTY="og:title" content="経営企画・コンサルタント職の方へ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー" />
<meta PROPERTY="og:type" content="website" /> 
<meta PROPERTY="og:url" content="https://kandc.com/mobile/landing/y-corporate-planning/" /> 
...
<meta PROPERTY="og:site_name" content="経営企画・コンサルタント職の方へ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー" />


<title>経営企画・コンサルタント職の方へ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー</title>
...
<div class="main_top inside">
  ...
  <h2 class="main_title"><img alt="もっともっとダイナミックなステージで活躍したい経営企画・コンサルタント職の方へ" src="<?php echo url_root_headhunter; ?>img/main-title.png" /></h2>
  <h3 class="sub_title"><img alt="あなたの人生の転機となる転職をキャリアパートナーが専属でバックアップ！" src="<?php echo url_root_headhunter; ?>img/main-sub-title.png" /></h3>
  ...
  <p>※CGDF資格を持つコンサルタントが、まずはあなたのお気持ち、ご経歴等を徹底的にヒアリング。その上でフィット感の高いポジションをご提案します。</p>
  </div>
  ...
  <p>心から納得のゆく転職成功のためには、タイミングが重要です。<br/>
魅力的なチャンスを逃さないよう、長期的にキャリアパートナーとしてお付き合いをさせていただき、スピーディに情報提供いたします。</p>
  </div>
  
  <p class="gcdf">
  <span class="gcdf_title">※GCDFとは？</span>
GCDF資格とは、米国CCE.Inc.が認定しているキャリアカウンセラー資格です。キャリアカウンセラーに必要な幅広い知識と実践的なスキルを身につけるため、120時間にも及ぶトレーニングプログラムを受講し、試験（筆記・実技）に合格すると資格が取得できます。
  </p>
</div>
...
<div class="voice_box">
<p class="voice_flow"><img alt="一部上場企業経営企画スタッフ→WEB系ベンチャー企業経営企画マネージャー" src="<?php echo url_root_headhunter; ?>img/voice01-flow.png" /></p>
<h4 class="voice_box_title"><img alt="自分一人では出会えないチャンスにめぐりあいました" src="<?php echo url_root_headhunter; ?>img/voice01-title.png" /></h4>
<p>当初は正直転職は考えていませんでした。ところが数か月後担当コンサルタントから、ある企業が新規事業の立ち上げにあたり新設する経営企画部門のマネージャーを探しているとの情報をいただき、まさに自分のキャリアが活かせるチャンスだと思い転職を決断。自分一人では絶対に出会えない機会にめぐりあうことができました。</p>
</div>
...
<div class="voice_box">
<p class="voice_flow"><img alt="大手教育系企業経営企画部長→WEB系企業関連会社社長" src="<?php echo url_root_headhunter; ?>img/voice03-flow.png" /></p>
