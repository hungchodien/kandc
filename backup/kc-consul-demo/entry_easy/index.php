...
var isMobile = window.matchMedia("only screen and (max-width: 767px)");
		if($('#text1').val() == '' || $('#text2').val() == '' || $('#text3').val() == '' || $('#text4').val() == '' ||  $('#select1 option:selected').val() == '' || $('#select2 option:selected').val() == '' || $('#select3 option:selected').val() == '' || $('#select4 option:selected').val() == '' || $('#text5').val() == '' || $('#text6').val() == '' || $('#text7').val() == '' || $('#text8').val() == '' || ($('#file1').val() == ''&& !isMobile.matches) )
				{
					$("#submit_form").submit();
				}
				else
        ...
        <td class="label">
         ...
         <td colspan="2">
                    <div class="td-content clear">
                        ...
                        <div class="easy_name"><input type="text" name="text1" id="text1" value="" onblur="validatetext(this.value, this.id)" onfocus="click_text(this.id)" style=" width:150px;" />
                        <p><span id="errortext1"></span></p>
                        </div>
                        <div class="name_label">名</div>
                        <div class="easy_name"><input type="text" name="text2" id="text2" value="" onfocus="click_text(this.id)" onblur="validatetext(this.value, this.id)" style=" width:150px;"/>
            ...
            <td class="label">
                ...
                <td colspan="2">
                    <div class="td-content clear">
                        ...
                        <div class="easy_name"> <input type="text" name="text3" id="text3" value="" onfocus="click_text(this.id)" onblur="validatetext(this.value, this.id)" style=" width:150px;"/>
                        <p><span id="errortext3"></span></p>
                        </div>
                        <div class="name_label">メイ</div>
                        <div class="easy_name"><input type="text" name="text4" id="text4" value="" onfocus="click_text(this.id)" onblur="validatetext(this.value, this.id)" style=" width:150px;"/>
            ...
            <tr>
                ...
                <td colspan="2">
                    <div class="td-content phone clear">
                       <div style="position:relative;">
                            <input type="text" name="text5" id="text5" value="" onblur="validatetext(this.value, this.id)" onfocus="click_text(this.id)"/> <span class="pc">-</span>
                            <p id="errortext5" class="error_box5"></p>
                       </div>
                       <div style="position:relative;">
                            <input type="text" name="text6" id="text6" value="" onfocus="click_text(this.id)" onblur="validatetext(this.value, this.id)"/> <span class="pc">-</span>
        ...
        <div class="table-personal-profile">
            <table>
                <tr>
                    ...
                    <td>
                        <div class="td-content clear">
                            <div><input class="w500" type="text" name="text10" id="text10" value="" placeholder="（例）○○大学 ○○学部 ○○学科"/></div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <div class="td-content clear">
                        <div>
                            <select class="selection w250" name="select5" id="select5">
...
<!----------------------************************--------------------------->
  ...
  <div class="form-personal-profile step_hiden pc">
    ...
    <div class="table-personal-profile">  
            ...
            <tr>
                ...
                <div class="fl">
                    ...
                    <div class="w250" style="margin:5px 0; font-size:11px; line-height:15px; float: right;">
        ...
        <table>
            <tr>
				...
				jQuery(document).ready(function ($) {
                    ...
                    <div class="td-content clear">
                        <div>
                            <select class="selection w400" name="select6" id="select6" onfocus="click_text(this.id)">
                     ...
                     <div class="td-content exchange_select clear">
                        ...
                        <textarea class="w400" style="margin-bottom: 10px" type="text" name="text14" id="text14" onfocus="click_text(this.id)" value=""></textarea></div></div>
                         <div class="select_show2 clear" style="margin:5px 0;">
                            <div class="clear">※具体的にご紹介された弊社コンサルタントがおりましたらお手数ですが下記よりご選択ください。</div>
                            <div class="clear">
                             <select class="selection w400" name="select7" id="select7">
                                            <option value="">下記から選択してください</option>
