...
<meta property="og:url" content="http://www.kandc.com/landing/agent-a/" /> 
...
<meta property="og:image" content="http://www.kandc.com/landing/agent-a/img/facebook-og-image.png" />
  ...
  style="border: 0; overflow: hidden;">
    ...
    <div id="header_img" class="container clear">
        	<div class="main_content clear">
            	<div class="main_title clear"><img src="img/main-title.png" alt="納得の人材紹介会社はもう、みつかりましたか？"/></div>
              	<div class="main_check clear">
                
                   <img src="img/main-check1.png" alt="ハイクラス転職支援の実績豊富な人材紹介会社に相談したい" />
                    <img src="img/main-check2.png" alt="一律の対応ではなく、自分のコンディションにあったサポートを受けたい" />
                    <img src="img/main-check3.png" alt="企業とのパイプが太く、交渉を行ってもらえる紹介会社を探している" />
                </div>
            </div>
    ...
    <div class="voice">
     ...
     <div id="form-area" class="form-area"> <!--big-->
    	<div class="form-title">
        	<img src="img/entry-title.png" alt="今すぐ転職をお考えの方も、将来的な転職を視野に入れている方もクライス＆カンパニーに相談してみませんか？＜完全無料＞" />
        </div>
