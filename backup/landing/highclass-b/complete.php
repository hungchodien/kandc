...
<script type="text/javascript" src="js/social.js">//Social (Facebook, Twitter)</script>
 <script type="text/javascript" src="https://apis.google.com/js/platform.js" async defer>//+1 Button (Google)</script> 
...
<div class="wrap">
    	...
    	<div class="complete ">
        	<p class="complete-title text-color">お申し込みありがとうございます。</p>
            <div class="complete-notice">
            	<p>1週間以内に担当のコンサルタントよりご連絡させて頂きますので、いましばらくお待ちください。 尚、1週間以内に弊社からの連絡がない場合は、ご連絡先の誤入力の可能性がございますので、 大変お手数ではございますが下記までご一報頂けますと幸いです。</p>
                <br />
                <p>また、ご経験やご希望の業界、職種、ご年齢などによってはご紹介が難しい場合がございますので ご了承願います。</p>
                <p>そのような場合も、ご紹介案件の有無など現状をご連絡させていただきます。</p>
                <div class="complete-contact">
	                <p class="text-color">お問合せ</p>
                    <p>TEL 03-5733-1602</p>
                    <p>Email kreis-info@kandc.com</p>
                </div>
                 <div class="clear btn_complete_back_home">
	           <a class="back-to-home" href="https://www.kandc.com/"><img src="img/button-kreis.png" alt="" /></a>
            </div>
            </div> <!--#complete-contact-->
...
var yahoo_conversion_label = "rKOACKqUwF8QgvPtvgM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="https://b91.yahoo.co.jp/pagead/conversion/1000240003/?value=0&amp;label=rKOACKqUwF8QgvPtvgM&amp;guid=ON&amp;script=0&amp;disvt=true"/>
</div>
</noscript>
