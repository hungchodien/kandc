...
<meta property="og:url" content="http://www.kandc.com/landing/executive-a/" /> 
...
<meta property="og:image" content="http://www.kandc.com/landing/executive-a/img/facebook-og-image.png" />
  ...
  style="border: 0; overflow: hidden;">
    ...
    <div id="header_img" class="container clear">
        	<div class="main_content clear">
            	<div class="main_title clear"><img src="img/main-title.png" alt="エグゼクティブにふさわしいプレミアム転職サポート"/></div>
              	<div class="main_check clear">
                
                   <img src="img/main-check1.png" alt="経験、能力が最大限に活かせる魅力的なオファーに出会いたい" />
                    <img src="img/main-check2.png" alt="専属コンサルタントと情報交換をして、自分の可能性を常に把握していたい" />
                    <img src="img/main-check3.png" alt="独自に開拓した、コンフィデンシャル案件を紹介して欲しい" />
                </div>
            </div>
    ...
    <div class="voice">
     ...
     <div id="form-area" class="form-area"> <!--big-->
    	<div class="form-title">
        	<img src="img/entry-title.png" alt="今すぐ転職をお考えの方も、将来的な転職を視野に入れている方もエグゼクティブのための転職サポートにエントリーしてみませんか？＜完全無料＞" />
        </div>
