...
カンパニー</title>
    ...
    <META HTTP-EQUIV="Refresh" CONTENT="0;URL=http://www.kandc.com/kc-recruit/entry/">
    <!--[if IE 9]>
    ...
    <div id="entry">
        <div id="entry-nav">
            <ul class="clear">
                ...
                <li><span class="process-recruit-step1"></span></li>
...
<div id="page" class="clear">
    <div class="title-page">
        <p class="sub-title-top">コンサルタント職への応募フォームです。</p>
    </div>
</div>
			...
			<div class="form-personal-profile">
            		<div class="table-personal-profile">
                        <div class="td-content clear">
                            ...
                            <p>　ネットワーク等のタイミングによりレジュメが添付できない場合がございます。その際には、お手数ですが下記メールアドレスまで 直接お送りください。<br />
　Email： recruit@kandc.com　管理本部　犬竹真弓</p>
                        </div>
                    </div>
			</div>
<!-------------------------------------------------------------->
