...
<div id="header_meta">
<title>ヘッドハンティング・人材紹介・転職エージェント・キャリアコンサルティングのクライスamp;カンパニー</title>
...
<div class="content_top"></div>
	...
	<div  id="footer_add_bread" class="clear">
    	<ul class="clear">
            ...
            <li class="bc_item"><a href="<?php echo url_root; ?>entry/">コンサルタント職</a></li>
             <li><a href="<?php echo url_root; ?>entry_recruit/">応募フォーム</a></li>
