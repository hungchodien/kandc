...
<div class="content_entry_recurit clear">
    ...
    <div class="title_content_entry_recurit clear">
    	<p class="top_1">エントリーマネージメントスタッフ</p>
        <p class="title_form">エントリーマネージメントスタッフ応募フォームです。</p>
...
<div  id="footer_add_bread" class="clear">
    	<ul class="clear">
            ...
            <li class="bc_item"><a href="<?php echo url_root; ?>entry/management/">エントリーマネージメントスタッフ</a></li>
            <li class="bc_item"><a href="<?php echo url_root; ?>entry/management/form">応募フォーム</a></li>
            <li>内容確認</li>
