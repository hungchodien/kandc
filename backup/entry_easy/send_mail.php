...
";				
					...
					if($consultant_id >0):
$admin_subject="HP-Entry (with resume and consultantid)";
$body_content="
----------------------------------------------------------------------
- 以下の求人コードへのエントリーです
----------------------------------------------------------------------
...
";
			...
			$title="【メインサイト】エントリー（添付有）";
				$entry_check="";
				if($order_id>0) $title="【メインサイト】求人指名エントリー（添付有）";
				if($company_id>0) $title="【メインサイト】企業指名エントリー（添付有）";
				if($consultant_id>0) $title="【メインサイト】コンサル指名エントリー（添付有）";
