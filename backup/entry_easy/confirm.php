<?php 
	...
	isset($_POST['text1']) && isset($_POST['text2']) && isset($_POST['text3']) && isset($_POST['text4']) && 
	isset($_POST['select1']) && isset($_POST['select2']) && isset($_POST['select3']) && isset($_POST['select4']) &&
	isset($_POST['text5']) && isset($_POST['text6']) && isset($_POST['text7']) && isset($_POST['text8']) && 
	isset($_POST['text9']) && 
	strlen(trim($_POST['text1']))>0 && strlen(trim($_POST['text2']))>0 && strlen(trim($_POST['text3']))>0 && 
	strlen(trim($_POST['text4']))>0 && strlen(trim($_POST['select1']))>0 && strlen(trim($_POST['select2']))>0 && 
	strlen(trim($_POST['select3']))>0 && strlen(trim($_POST['select4']))>0 && strlen(trim($_POST['text5']))>0 && 
	strlen(trim($_POST['text6']))>0 && strlen(trim($_POST['text7']))>0 && (!empty($_FILES['upload1']['name']) || !empty($_FILES['upload2']['name'])) ):
