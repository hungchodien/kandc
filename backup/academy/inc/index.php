...
<div id="about">
    <div class="about_wrapper">
        ...
        <p class="about_txt">「汐留アカデミー」とは、各分野でご活躍されているプロフェッショナルな方々を講師としてお招きし <span class="text-point">Input</span>と<span class="text-point">Networking</span>によって挑戦への熱量を高めていただく、クライス＆カンパニー主催のセミナー＆交流会です。
        <br><br>
イベント前半部は、講師の方の転機にまつわるエピソードや、生き方のポリシー、成果を出す秘訣などをお聞きし、皆さまに<span class="text-point">Input</span>をしていただくお時間。そして後半部は、講師の方々や参加者の皆さま同士で交流いただく<span class="text-point">Networking</span>の場とさせていただきます。講師の方々から得られる知恵・ヒント。そして共通の課題意識をもつ皆さま同士のリアルな交流によって、明日新たな一歩を踏み出していくための熱量が高まる場となれば嬉しく思います。
<br><br>
尚、毎回のテーマにご関心をお持ちいただける方であれば参加条件は特にございません。
参加をご希望される方は、当webサイトの　参加申込フォーム　よりお申込みください。
ただし、少人数制で開催しておりますため、お申込み数が募集人数を超えた場合は、抽選とさせていただいておりますこと御了承ください。
<br><br>
皆様とお会い出来ますこと心より楽しみにしております。
</p>
