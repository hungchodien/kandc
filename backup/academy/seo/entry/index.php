<?php 
	...
	$where="and `A`.`shiodome_academy_status`=0 and `A`.`shiodome_academy_id`='$sid' order by `A`.`shiodome_academy_date` DESC";
	 $Data_shiodome_list =Get_Data("shiodome_academy as A join shiodome_academy_join_category as B on
A.shiodome_academy_id=B.shiodome_academy_id join shiodome_academy_category as C on B.shiodome_academy_category_id=C.shiodome_academy_category_id", $where,"A.seo_keyword,A.seo_description,A.seo_og_description,A.seo_og_title,A.seo_add_thumb_meta,A.shiodome_academy_theme,A.shiodome_academy_time,A.shiodome_academy_place,A.shiodome_academy_guest,A.shiodome_academy_description,C.shiodome_academy_category_name_ja,A.shiodome_academy_date,A.shiodome_academy_thumbnail,A.shiodome_academy_thumbnail_alt,C.shiodome_academy_category_name_en,`A`.`shiodome_academy_contents`,`C`.`shiodome_academy_category_slug`");
	$count_item= $Data_shiodome_list['cnt'];
		$title_category=$Data_shiodome_list['shiodome_academy_category_name_ja'];
	    $seo_keyword =htmlspecialchars_decode($Data_shiodome_list['seo_keyword']);
		$seo_description=htmlspecialchars_decode($Data_shiodome_list['seo_description']);
		$seo_og_description=htmlspecialchars_decode($Data_shiodome_list['seo_og_description']);
		$seo_og_title=htmlspecialchars_decode($Data_shiodome_list['seo_og_title']);
		$seo_add_thumb_meta=$url_images_fure.$Data_shiodome_list['seo_add_thumb_meta'];
		$date_shiodome_top=$Data_shiodome_list['shiodome_academy_date'];
		$guest_top=unserialize($Data_shiodome_list['shiodome_academy_guest']);
		$category_shiodome_academy_slug=$Data_shiodome_list['shiodome_academy_category_slug'];
