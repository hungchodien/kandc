...
<div id="top_banner">
    ...
    <div id="top_txt">
    <p id="main_txt"><img title="ご転職をお考えの”20代”のあなたへ この転職があなたの人生を変えるだろう。だから最強のサポーターをつけてほしい。" alt="ご転職をお考えの”20代”のあなたへ この転職があなたの人生を変えるだろう。だから最強のサポーターをつけてほしい。" src="<?php echo url_root;?>img/main-text.png" /></p>
    <p id="top_entry_btn"><a href="#"><img title="転職支援サービスに申し込む" alt="転職支援サービスに申し込む" src="<?php echo url_root;?>img/button-entry-small.png" /></a></p>
    </div>
    <div id="top_pic"><img title="30代の転職ならクライス＆カンパニー" alt="30代の転職ならクライス＆カンパニー" src="<?php echo url_root;?>img/main.png" /></div>
    </div>
</div>
<div class="features_btns">
<ul class="f_btns inside clear">
<li class="f1_btn"><a href="#"><img title="キャリアプラン設計からサポート" alt="キャリアプラン設計からサポート" src="<?php echo url_root;?>img/button-features01.png" /></a></li>
<li class="f2_btn"><a href="#"><img title="コンサルタントが採用まで専任でサポート" alt="コンサルタントが採用まで専任でサポート" src="<?php echo url_root;?>img/button-features02.png" /></a></li>
<li class="f3_btn"><a href="#"><img title="優良ベンチャーから大手企業まで豊富な案件" alt="優良ベンチャーから大手企業まで豊富な案件" src="<?php echo url_root;?>img/button-features03.png" /></a></li>
</ul>
</div>
...
<div id="wrapper" class="clear">
  ...
  <h1><img title="私たちは、20代の転職を成功に導きます。" alt="私たちは、20代の転職を成功に導きます。" src="<?php echo url_root;?>img/main-title.png" /></h1>
  <h2><img title="あなたの今後の可能性を広げることが私たちのミッションです。" alt="あなたの今後の可能性を広げることが私たちのミッションです。" src="<?php echo url_root;?>img/sub-title.png" /></h2>
  </div>
  
  <div id="consultants">
  <div class="consultant_block clear">
  <div class="consultant_tmb"><img title="シニアコンサルタント 松尾 匡起" alt="シニアコンサルタント 松尾 匡起" src="<?php echo url_root;?>img/consultant-matsuo.png" /></div>
  <div class="consultant_txt">
  
  <h3><img title="「エージェントなんてどこも一緒」とお考えの方の期待を越えるサービスを提供したいと考えています。" alt="「エージェントなんてどこも一緒」とお考えの方の期待を越えるサービスを提供したいと考えています。" src="<?php echo url_root;?>img/matsuo-title.png" /></h3>
  <p>私は、企画系職（経営企画・事業企画・マーケティング）、コンサルタント（戦略系・会計系・IT系）の特に20代後半～30代のミドル層を得意としています。<br />
20代後半～30代になるとスキルだけではなく、カルチャー、理念等へのフィット感も重要な判断軸になると感じています。「自分らしい生き方」、「自分らしく生きるための働き方」、を皆さまと共に日々本気で模索しています。<br />
今後成長が見込めるようなベンチャー、新興企業から大手企業まで、経営者のビジョンに共感できる環境を希望される方はぜひお会いしましょう。</p>
  </div>
  </div>
  ...
  <h3><img title="「仕事」だけではなく「人生全体」をキャリアと捉え、皆さまの転職サポートをさせていただきます。" alt="仕事」だけではなく「人生全体」をキャリアと捉え、皆さまの転職サポートをさせていただきます。" src="<?php echo url_root;?>img/okada-title.png" /></h3>
  <p>現在まで4000名以上の方の転職サポートをさせていただき、企業のコアなポジションを500件以上成約させて参りました。お付き合いさせていただいた転職希望者の多くは、20代後半～30代といったリーダー、シニアクラスがメインです。<br />
特に20代後半の方は、30代の更なるキャリアアップに向け新しい環境を求める方、結婚などのプライベートにおける変化があり今後に漠然とした不安をお持ちの方など人生の転機を迎える方が多いと感じています。そんな皆さまと一緒に、あなたが更に力を発揮できる環境を考え、充実した生活を送るお手伝いができればと思っています。</p>
  </div>
  <div class="consultant_tmb2"><img title="シニアコンサルタント 半藤 剛" alt="シニアコンサルタント 半藤 剛" src="<?php echo url_root;?>img/consultant-okada.png" /></div>
  </div>
  
  <div class="consultant_block clear">
  <div class="consultant_tmb"><img title="チーフコンサルタント 越山 恵理" alt="チーフコンサルタント 越山 恵理" src="<?php echo url_root;?>img/consultant-takeda.png" /></div>
  <div class="consultant_txt">
  
  <h3><img title="転職ありきではなく、貴方が更に輝けるための結論が出せるところまで、とことんお付き 合いいたします。" alt="転職ありきではなく、貴方が更に輝けるための結論が出せるところまで、とことんお付き 合いいたします。" src="<?php echo url_root;?>img/takeda-title.png" /></h3>
  <p>今後の仕事・キャリアの面で悩んだ時、必ず大切な場面に直面します。それは、「決断の場面」です。<br />
迫られた決断ではなく、後悔の無いように「攻めの決断」をしていただけるよう、皆様が持っているエネルギーを、ご自身で「気付き」「感じて」いただけるよう、サポートさせていただきます。<br />
私は、「躍動感あふれる」企業から「安定感のある」企業まで、前進し続ける企業とも多くお付き合いがあります。特にWeb・モバイルなどのインターネット業界やコンサルティング業界に強みを持っておりますので、同業界でのご転職をお考えの方はぜひご相談ください。</p>
  </div>
  </div>
  ...
  <div class="entry_btn"><a href="#"><img title="転職支援サービスに申し込む" alt="転職支援サービスに申し込む" src="<?php echo url_root;?>img/button-entry.png" /></a></div>
  
  </div><!--end .content_consultant-->
  
  <div id="features01">
  <h1 class="features_title"><img title="キャリアプラン設計からサポート" alt="キャリアプラン設計からサポート" src="<?php echo url_root;?>img/title-features01.png" /></h1>
  <div class="contents">
  <div class="features01_content clear">
  <div class="features01_desc">
  <h2><img title="お一人では気づかない新たな可能性を発掘し、実現することがプロに相談するメリットです！" alt="お一人では気づかない新たな可能性を発掘し、実現することがプロに相談するメリットです！" src="<?php echo url_root;?>img/f01-h2.png" /></h2>
  
  <p>20代後半～30代の方に求められるポジションは、リーダー・マネージャー候補以上になりますので、当然企業側のジャッジも厳しくなります。プライベートにおいても人生の転機を迎える方が多く、転職を一人の都合で決断できない状況に置かれているのではないでしょうか。<br />
また、若い頃から急速なスピードで実績と経験を積んでこられた方であれば、次のステージへの希望も高く、条件も複雑です。単なる情報と情報のマッチングで成功しないのがミドル層の転職です。そこで私たちが介入することによって成功へのお手伝いができればと思っています。</p>
<h3>30歳からさらなる飛躍を求める20代後半の方、<br />
30代におけるキャリアを真剣に考える方々を私たちは支援いたします。</h3>
  </div>
  <div class="features01_tmb"><img title="" alt="" src="<?php echo url_root;?>img/f01-image.png" alt="キャリアプラン設計からサポート写真01" />
  </div>
  </div>
  <div class="entry_btn"><a href="#"><img title="転職支援サービスに申し込む" alt="転職支援サービスに申し込む" src="<?php echo url_root;?>img/button-entry.png" /></a></div>
  </div>
  ...
  <div id="features02">
  <h1 class="features_title"><img title="コンサルタントが採用まで専任でサポート" alt="コンサルタントが採用まで専任でサポート" src="<?php echo url_root;?>img/title-features02.png" /></h1>
  <div class="content_consultant">
  <h2 class="features02_h2"><img title="「GCDF資格の取得」「C&R方式」を実践している優秀なコンサルタントが専任でサポートします！" alt="「GCDF資格の取得」「C&R方式」を実践している優秀なコンサルタントが専任でサポートします！" src="<?php echo url_root;?>img/f02-h2.png" /></h2>
  <p class="contents">20代後半～30代のミドル層の方をサポートする上で、私たち自身も幅広い知識とスキルが要求されます。それにお応えできるよう、当社では、年間100時間を越える社内外の研修を通して、コンサルタント一人ひとりのコンサルティング力の向上を図っています。<br />
...
また、独自に開発した「キャリアコンサルタントトレーニングプログラム」や、「コーチング研修」などを行い、それらを受講することによって、アセスメント技術の向上や倫理観の確立に努めています。</p>
  ...
  <div class="gcdf_block gcdf_block1 fl">
  <h3>GCDFとは？</h3>
...
GCDF資格とは、米国CCE.Inc.が認定しているキャリアカウンセラー資格です。キャリアカウンセラーに必要な幅広い知識と実践的なスキルを身につけるため、120時間にも及ぶトレーニングプログラムを受講し、試験（筆記・実技）に合格すると資格が取得できます。</p>
  ...
  <div class="gcdf_block gcdf_block2 fr">
  <h3>C&amp;R方式とは？</h3>
...
C&amp;R方式の最大のメリットは、企業のニーズをしっかり把握でき、候補者の方のキャリアや性格もよく知った上で、その方に適した企業を見つけ出すことができますので、ミスマッチも少なく、企業、転職者双方が満足できる確率が高くなります。</p>
  ...
  <h2>クライス&amp;カンパニーのGCDF資格</h2>
  <ul class="gcdf_certificate clear">
  <li><img title="GCDF資格:エグゼクティブコンサルタント 岡田 麗" alt="GCDF資格:エグゼクティブコンサルタント 岡田 麗" src="<?php echo url_root;?>img/gcdf-okada.png" /></li>
  <li><img title="GCDF資格:シニアコンサルタント 奈良 元生" alt="GCDF資格:シニアコンサルタント 奈良 元生" src="<?php echo url_root;?>img/gcdf-nara.png" /></li>
  <li><img title="GCDF資格:シニアコンサルタント 半藤 剛" alt="GCDF資格:シニアコンサルタント 半藤 剛" src="<?php echo url_root;?>img/gcdf-hando.png" /></li>
  <li><img title="GCDF資格:シニアコンサルタント 松尾 匡起" alt="GCDF資格:シニアコンサルタント 松尾 匡起" src="<?php echo url_root;?>img/gcdf-matsuo.png" /></li>
  <li><img title="GCDF資格:シニアコンサルタント 入江 祥之" alt="GCDF資格:シニアコンサルタント 入江 祥之" src="<?php echo url_root;?>img/gcdf-irie.png" /></li>
  <li><img title="GCDF資格:チーフコンサルタント 武田 直人" alt="GCDF資格:チーフコンサルタント 武田 直人" src="<?php echo url_root;?>img/gcdf-tanaka.png" /></li>
  <li><img title="GCDF資格:チーフコンサルタント 永田 憲章" alt="GCDF資格:チーフコンサルタント 永田 憲章" src="<?php echo url_root;?>img/gcdf-nagata.png" /></li>
  </ul>
  </div>
  <div class="entry_btn"><a href="#"><img title="転職支援サービスに申し込む" alt="転職支援サービスに申し込む" src="<?php echo url_root;?>img/button-entry.png" /></a></div>
  ...
  <div id="features03">
  <h1 class="features_title"><img title="優良ベンチャーから大手企業まで豊富な案件" alt="優良ベンチャーから大手企業まで豊富な案件" src="<?php echo url_root;?>img/title-features03.png" /></h1>
  <div class="contents">
  <div class="features01_content clear">
  <div class="features03_tmb"><img title="企業と長期的なお付き合いをすることで、独占案件を豊富に保有することができます。" alt="企業と長期的なお付き合いをすることで、独占案件を豊富に保有することができます。" src="<?php echo url_root;?>img/f03-image.png" />
  </div>
  
  <div class="features03_desc">
  <h3><img title="企業と長期的なお付き合いをすることで、独占案件を豊富に保有することができます。" alt="企業と長期的なお付き合いをすることで、独占案件を豊富に保有することができます。" src="<?php echo url_root;?>img/f03-h2.png" /></h3>
  <p>在籍するコンサルタントはそれぞれ得意分野をもっており、長期にわたり企業とお付き合いするケースが多数あります。<br />
そのため、企業からは戦略面から、組織、採用のご相談を承っているため、エクスクルーシブ案件、非公開求人が多い傾向があります。信頼関係を構築することで採用ニーズが顕在化していない場合でも、経営課題の解決を実現いただける強みをお持ちの方をご推薦させていただく動きができる点も強みです。</p>
  ...
  <div id="voice">
  <h1 class="features_title"><img title="ユーザーの声" alt="ユーザーの声" src="<?php echo url_root;?>img/title-voice.png" /></h1>
  <div class="contents">
  
  <div class="voice_content clear">
  
  <div class="voice_block">
  <div class="voice_icon"><img title="30歳 男性" alt="30歳 男性" src="<?php echo url_root;?>img/icon-voice01.png" /></div>
  <p class="voice_desc">大手小売企業　マーケティング職</p>
  <p class="voice_arrow"><img title="矢印" alt="矢印" src="<?php echo url_root;?>img/voice_arrow.png" /></p>
  <p class="voice_category">情報総合サービス企業<br />
サービス企画担当</p>
  <p class="voice_arrow2"><img title="矢印" alt="矢印" src="<?php echo url_root;?>img/voice_arrow2.png" /></p>
  <div class="voice_txt">
 <!-- <h3>私の想いに共感し、聴き、<br />
話すという対応に<br />
感謝しています</h3>-->
<p>自分のやりたい仕事や進んでいきたいキャリア像がまったくわからなかったので、そこがクリアになり、かつ自分に合った職につけたらいいなと考えていました。
企業をご紹介いただく際に、どういった点でこの企業がおすすめかを詳しくご説明いただけたので、自分のやりたい仕事が分かっただけでなく、一人では思いつかなかった新たな可能性にも気づくことができました。選考を進める中でも手厚くフォローしていただき、二人三脚で転職活動に臨めたため、心強かったです。</p>
  </div>
  </div><!--end .voice_block-->
  
  <div class="voice_block">
  <div class="voice_icon"><img title="32歳 男性" alt="32歳 男性" src="<?php echo url_root;?>img/icon-voice02.png" /></div>
  <p class="voice_desc">特殊法人　広報</p>
  <p class="voice_arrow"><img title="矢印" alt="矢印" src="<?php echo url_root;?>img/voice_arrow.png" /></p>
  <p class="voice_category">人事・組織コンサルティングファーム<br />
コーチ・アシスタント</p>
  <p class="voice_arrow2"><img title="矢印" alt="矢印" src="<?php echo url_root;?>img/voice_arrow2.png" /></p>
  <div class="voice_txt">
   <!--<h3>クオリティの高い<br />
対応に満足しています<br /><br /></h3>-->
<p>求人案件の情報量は他社と同程度でしたが、選考時に提供頂けるアドバイスは過去経験に基づいた的確な内容が豊富だでした。また、自分で「ここは受けない」と思い込んでいた企業についても、経歴とキャリア観に合致しそうな案件であればしっかりとご紹介いただけたため、キャリアの可能性が広がり、納得いく転職先を見つけることができました。</p>
  </div>
  </div><!--end .voice_block-->
  
  <div class="voice_block last_child">
  <div class="voice_icon"><img title="35歳 女性" alt="35歳 女性" src="<?php echo url_root;?>img/icon-voice03.png" /></div>
  <p class="voice_desc">戦略コンサルティングファーム　コンサルタント</p>
  <p class="voice_arrow"><img title="矢印" alt="矢印" src="<?php echo url_root;?>img/voice_arrow.png" /></p>
  <p class="voice_category">大手web企業<br />
戦略プロジェクトリーダー</p>
  <p class="voice_arrow2"><img title="矢印" alt="矢印" src="<?php echo url_root;?>img/voice_arrow2.png" /></p>
  <div class="voice_txt">
   <!--<h3>私の潜在的ニーズを<br />
突き止めてくれました<br /><br /></h3>-->
<p>海外駐在しており、時差や仕事の関係で電話でのご相談が難しい中、メールでのやりとりだけでもスピードやタイミング、正確性等によって電話以上のコミュニケーションがとれ、スムーズに転職活動を行うことができました。選考における技術面のアドバイスのみならず、今後の方向性等について真剣に向き合うことを教えていただきました。一人では今回の転職活動を満足に終えることはできなかったと思います。</p>
  </div>
  </div><!--end .voice_block-->
...
<div class="inside">
<div id="form">
<h1 class="form_title"><img title="専任のコンサルタントがエントリー～入社までトータルサポートいたします。無料サービスですのでまずは下記フォームよりお申込みください。" alt="専任のコンサルタントがエントリー～入社までトータルサポートいたします。無料サービスですのでまずは下記フォームよりお申込みください。" src="<?php echo url_root;?>img/title-form.png" /></h1>
