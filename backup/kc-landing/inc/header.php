...
<meta PROPERTY="og:url" content="http://kandc.com/landing-20/" /> 
...
$protocol = strpos(strtolower($_SERVER['SERVER_PROTOCOL']),'https') 
			...
			define('url_root',$protocol."//".$_SERVER["SERVER_NAME"].'/kc-landing/');
...
<script type="text/javascript" src="<?php echo url_root_http;?>js/validate_form_entry.js"></script>
...
<header>
    ...
    <div id="logo" class="fl"><a href="<?php echo $protocol;?>//kandc.com/"><img title="クライス＆カンパニー" alt="クライス＆カンパニー" src="<?php echo url_root;?>img/logo-kreis.png" /></a></div>
  	<!-- Social button -->
