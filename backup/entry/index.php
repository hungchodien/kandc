                ...
                <td class="pd10">
                    <div class="td-content phone clear" >
                       <div style="position:relative;">
                            <input class="phone_require bg_error_fx" onblur="validatetext(this.value, this.id)" type="text" name="text5" id="text5" value="" style="-webkit-ime-mode:inactive;-moz-ime-mode:inactive;-ms-ime-mode:inactive;ime-mode:inactive;" onfocus="click_text_error(this.id)"/> <span class="pc">-</span>
    ...
    <div class="table-personal-profile">
        <table>
            <tr>
                ...
                <td>
                    <div class="td-content clear">
                        <input type="text" name="text10" id="text10" value="" class="w580" onfocus="click_text(this.id)"/>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="td-content clear">
                        <div class="none_float_mobile">
                            <select class="selection w250" name="select5" id="select5" onfocus="click_text(this.id)">
            ...
            <tr>
                ...
                <td>
                    <div class="td-content clear">
                        <div>
                            <textarea rows="1" cols="50" class="w580" type="text" name="text12" id="text12" value="" onfocus="click_text(this.id)"></textarea>
                        </div>
                    </div>
                </td>
            </tr>
...
<tr>
    ...
    <td>
        <div class="td-content clear" style="position:relative;">
        	<em class="clear">
            <div class="l" style="margin:0;"><input class="w400" style="margin-bottom: 10px" type="text" name="text14" id="text14" value="" onfocus="click_text(this.id)"/>
            </div>
            <div class="l">
            <!--<input style="width: 100px; margin-bottom: 10px" type="text" name="text15" id="text15" onfocus="click_text(this.id)"
                        value=""/>-->
            <select id="select15" name="text15" class="selection w250" style="padding:3px;" onfocus="click_text(this.id)" >
            ...
            <p class="clear">※直近の職歴についてご入力ください。</p>
        </div>
    </td>
</tr>
<tr>
    ...
    <td>
       <div class="td-content clear" style="position:relative;">
            <div>
                <select class="selection w400" name="select6" id="select6" onblur="validateSelect(this.value, this.id)" onfocus="click_text(this.id)">
...
<tr>
    ...
    <td>
        <div class="td-content td-content-bottom select_txt clear">
        <div class="none_float_mobile clear">
            <div>西暦</div>
            <div>
            ...
            <div>年</div>
            <div>
                <select class="selection selection-style select_date" name="select8" id="select8" onfocus="click_text(this.id)">
                    <option value=""> 選択</option>
                    <?php $moth = 1;
                    $endMoth = 12;
                    for ($moth; $moth <= $endMoth; $moth++) {
            ...
            <em class="break_line_mobile clear">
            <div>
            ...
            <div>年</div>
            <div>
                <select class="selection selection-style select_date" name="select10" id="select10" onfocus="click_text(this.id)">
                    <option value=""> 選択</option>
                    <?php $moth = 1;
                    $endMoth = 12;
                    for ($moth; $moth <= $endMoth; $moth++) {
...
<tr>
    ...
    <td>
        <div class="td-content clear">
            <div class="w400"><input style="width: 98%; margin-bottom: 10px" type="text" name="text16" id="text16" value="" onfocus="click_text(this.id)"/></div>
...
<tr>
    ...
    <td>
        ...
        <div  id = "desctext18"class="desc_hidden "><span>職務経歴書をお持ちの方は、職務経歴書の内容を貼り付けてください。お持ちでない方は箇条書きで入力してください</span></div>
            ...
            <textarea class="bg_error_fx big_textarea" type="text" name="text18" id="text18" value="" onfocus="click_text_error(this.id)" onblur="validatetext(this.value, this.id)" ></textarea>
...
<textarea class="big_textarea" type="text" name="text19" id="text19"  onfocus="click_text(this.id)"></textarea>
    ...
    <div class="table-personal-profile">
        <table>
            <tr>
                ...
                <td>
                        <div><input class="w500" type="text" name="text20" id="text20" value=""  onfocus="click_text(this.id)"/></div>
                </td>
            </tr>
        </table>
    </div>
        ...
        <table>
            <tr>
				...
				jQuery(document).ready(function ($) {
                    ...
                    <div class="td-content clear">
                            <select class="selection w400" name="select12" id="select12" onfocus="click_text(this.id)">
                     ...
                     <div class="td-content exchange_select clear">
                        ...
                        <textarea class="w400" style="margin-bottom: 10px" type="text" name="text21" id="text21" value="" onfocus="click_text(this.id)"></textarea></div></div>
                         <div class="select_show2 clear" style="margin:5px 0;">
                            ...
                            <div class="clear">
                             <select class="selection w400" name="select13" id="select13" onfocus="click_text(this.id)">
