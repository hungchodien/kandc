		...
		<div id="post_body" class="clearfix">
			<div id="post_body_content">
                ...
                <div class="clear hightligths_group" style="padding:10px; margin:0 0 10px 0; background:#E2DDC0;<?php if($page_number!=1):echo "display:none;";endif; ?>">
	                <label for="highlights"><b style="color:#7d7d7d; font-size:16px;">Highlights</b>
...
jQuery(document).ready(function($){
 ...
 <br /> 
    ...
    <div class="clear group_link_realeated">  
       <p class="title_txt">Link Realeated</p>  
       <div class="link_realeated clear">
            ...
            <label class="post_realeated_check" for="hiden_post"><input type="checkbox" value="1" name="hiden_post" id="hiden_post" <?php if($link_realeated_check==1): ?>checked="checked"<?php endif; ?> style="vertical-align:middle;"/> Hide Post</label>
	  </div><!--item_roundtable--> 
 ...
 <script type="text/javascript">
	...
	var item_roundtable='<div class="item_roundtable clear"><p class="title_txt">Main コンサルタント座談会</p><input id="post_title" class="main_roundtable" type="text" name="main_roundtable'+count_div_group_roundtable+'" value="" /><p class="title_txt">Title コンサルタント座談会</p><input id="post_title" class="title_roundtable" type="text" name="title_roundtable'+count_div_group_roundtable+'" value="" /><p class="title_txt">Link コンサルタント座談会</p><input id="post_title" type="text" class="link_roundtable" name="link_roundtable'+count_div_group_roundtable+'" value="" /></div><!--item_roundtable-->';
     ...
     <div class="clear container_roundtable">
            ...
            <div class="group_roundtable clear">
				...
				?>
                <input class="roundtable_txt" type="hidden" value="<?php if(count($content_roundtable)>0):echo count($content_roundtable);else: echo "0"; endif; ?>" name="roundtable_item">
                <?php
...
$(document).ready(function() {
	...
	$(".vol_number_slug").autocomplete(data_value).result(function(){
			...
			$.each(link_roundtable_value,function(j,data_roundtable){
				...
				var k=j+1;
			    html_apend_roundtable += '<div class="item_roundtable clear"><p class="title_txt">Main コンサルタント座談会</p><input type="text" value="'+data_roundtable.main+'" name="main_roundtable'+k+'" id="post_title"><p class="title_txt">Title コンサルタント座談会</p><input type="text" value="'+data_roundtable.title+'" name="title_roundtable'+k+'" id="post_title"><p class="title_txt">Link コンサルタント座談会</p><input id="post_title" type="text" value="l'+data_roundtable.link+'" name="link_roundtable'+k+'"></div>';
			});
