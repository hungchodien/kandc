	...
	<div id="content_body" class="fl">
		<div id="post_body" class="clearfix">
			<div id="post_body_content">
                ...
                <input id="post_title" type="text" name="title_interview" value="<?php echo $title;?>" />
                </div>
                
                <div class="clear">
                <p class="title_txt">記事のタイトル</p>
                <input id="post_title" type="text" name="subtitle_interview" value="<?php echo $subtitle;?>" />
                </div>
                
                <div class="clear">
                	<p class="title_txt">話者氏名（例：山田 太郎）</p>
                	<input id="post_title" type="text" name="fullname_interview" value="<?php echo $fullname_interview; ?>" />
                </div>
					...
					<div id="post_tabs" class="clearfix post_edit_block">
						<div class="tab_container">
							<div class="editor-container" id="content-editor-container">
								...
								<!--contents-->
								<textarea id="excerpt" name="excerpt" cols="40" style="height: 295px;"><?php echo $excerpt_interview; ?></textarea>
							</div>
						</div>
					</div>
				</div>
...
$Data_consul_content = To_Get_Data("consultant", $where_total_consul_content);
	...
	?>							
                ...
                <input id="post_title" type="text" name="keyword_interview" value="<?php echo $keyword_interview ;?>" />
                </div>
                
                <div class="clear">
                <p class="title_txt">SEO <?php echo htmlspecialchars("<meta>"); ?> Description:</p>
                		<input id="post_title" type="text" name="description_interview" value="<?php echo $description_interview ;?>" />
