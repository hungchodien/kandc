<?php 
	...
	$id_f=$_GET['id'];
		...
		{
			$List = Get_Data("interview_index", "and id_index_interview = $id_f");
			$op_vis_str = ($List['op_vis'] == "0") ? "Public" : "Draft";
			$op_vis = $List['status_index_interview'];
			$title = $List['title_index_interview'];
			$subTitle_index_interview=$List['subTitle_index_interview'];
			$excerpt_index_interview  = htmlspecialchars_decode($List['excerpt_index_interview']);
			$link_index_interview  = $List['link_index_interview'];
			$thumbnail=$List['thumbnail_index_interview'];
			$targer_index_interview  = $List['targer_index_interview'];
			
			$thumbnail_index_interview =$List['thumbnail_index_interview'];
			$thumbnail_alt=$List['thumbnail_index_interview_alt'];
