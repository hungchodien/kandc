<?php 
	...
	$id_f=$_GET['id'];
		...
		{
			$List = Get_Data("data_case", "and data_case_id = $id_f");
			$op_vis_str = ($List['data_case_status'] == "0") ? "Public" : "Draft";
			$op_vis = $List['data_case_status'];
			$title = $List['data_case_title'];
			$subtitle= $List['data_case_subtitle'];
			
			$content = htmlspecialchars_decode($List['data_case_content']);
			...
			list($op_front, $op_bottom) = explode(" ", $List['data_case_date']);
	...
	<div id="content_body" class="fl">
		<div id="post_body" class="clearfix">
			<div id="post_body_content">
                ...
                <input id="post_title" type="text" name="data_case_title" value="<?php echo $title;?>" />
                </div>
               
               <div class="clear">
                <p class="title_txt">Sub Title</p>
                <input id="post_title" type="text" name="data_case_subtitle" value="<?php echo $subtitle;?>" />
                </div> 
                        ...
                        <div id="post_tabs" class="clearfix post_edit_block">
                            <div class="tab_container">
                                <div class="editor-container" id="content-editor-container">
                                    ...
                                    <!-- 내용 -->
                                    <textarea id="data_case_content" name="data_case_content" cols="40" style="height: 295px;"><?php echo $content;?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
	...
	jQuery(function($){
		...
		CKEDITOR.replace('data_case_content',{
                  width: '100%',
                  resize_maxWidth: '100%',
                  resize_minWidth: '100%', 
				  height:'300'
		...
		CKEDITOR.instances['data_case_content'];
