<?php 
	...
	$id_f=$_GET['id'];
		...
		{
			$List = Get_Data("categgory_career_up", "and categgory_career_up_ID = $id_f");
			$op_vis_str = ($List['categgory_career_up_Status'] == "0") ? "Public" : "Draft";
			$op_vis = $List['categgory_career_up_Status'];
			$title = $List['categgory_career_up_Name'];
			...
			list($op_front, $op_bottom) = explode(" ", $List['categgory_career_up_Date']);
	...
	<div id="content_body" class="fl">
		<div id="post_body" class="clearfix">
			<div id="post_body_content">
            	<div class="clear">
            	 <p class="title_txt">Name Category Career Up</p>
				<input id="post_title" type="text" name="category_career_up" value="<?php echo $title;?>" />
                </div>
