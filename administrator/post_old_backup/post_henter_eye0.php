	...
	<div id="content_body" class="fl">
		<div id="post_body" class="clearfix">
			<div id="post_body_content">
                ...
                <input id="post_title" type="text" name="title_henter_eye" value="<?php echo $title;?>" />
                </div>
                <div class="clear">
                        ...
                        <div id="post_tabs" class="clearfix post_edit_block">
                            <div class="tab_container">
                                <div class="editor-container" id="content-editor-container">
                                    ...
                                    <!-- 내용 -->
                                    <textarea id="description_hunter" name="description_hunter" cols="40" style="height: 295px;"><?php echo $description_hunter;?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
//echo $Data_count['count_num'];
 ...
 <!--End ICon CheckBox **************************************************************-->
    <!--Caption-Option -->
              <div class="clear">
              		<div class="caption_s">
                    	<div class="title_txt">Caption</div>
                        <div class="clear">
