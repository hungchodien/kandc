           ...
           <div class="clear" style="padding:5px 0; background-color:#F3F3F3;">
                    ...
                    <div class="clear">
                     ...
                     <div class="clear">
                        ...
                        <div id="post_container" class="clearfix">
                            <!-- 내용 -->
                            <textarea id="company_interviews_description" name="company_interviews_description" cols="40" style="height: 100px; width:100%;"><?php echo $company_interviews_description; ?></textarea>
                        </div>
                       </div>
                       <br />
                       <div class="clear">
               ...
               <div class="clear">
                ...
                <div class="clear">
                	...
                	<input id="post_title" class="subject_company_interview" type="text" name="company_interviews_subject" value="<?php echo $company_interviews_subject;?>" />
                </div>
				...
				<script type="text/javascript">
					jQuery(document).ready(function($){
						...
						$('.title_company').bind('input keyup keydown keypress', function(){
							var title_company=$(this).val();
							var subject_company=$('.subject_company_interview').val();

							//var seo_description=title_company+"の"+subject_company+"に関するインタビュー";
							var seo_description=title_company+"の"+subject_company+"に関するインタビューです。";
							$('#seo_description').val(seo_description);
						});
						$('.subject_company_interview').bind('input keyup keydown keypress', function(){
							var title_company=$('.title_company').val();
							var subject_company=$(this).val();
							//var seo_description=title_company+"の"+subject_company+"に関するインタビュー";
							var seo_description=title_company+"の"+subject_company+"に関するインタビューです。";
							$('#seo_description').val(seo_description);
							$("#seo_keyword").val("ヘッド,ハンティング,転職,支援,人材,紹介,30代,コンサルティング,コラム,キャリア,"+subject_company);
							
						});
						$('.subtitle_company').bind('input keyup keydown keypress', function(){
							var subtitle_company=$(this).val();
							$('#seo_og_title').val(subtitle_company);
						});
						$('#company_interviews_description').bind('input keyup keydown keypress', function(){
							var company_interviews_excerpt=$(this).val();
							$('#seo_og_description').val(company_interviews_excerpt);
						});
                 ...
                 <div class="clear">
                    ...
                    <div id="post_container" class="clearfix">
                        <!-- 내용 -->
                          <textarea id="seo_keyword" name="seo_keyword" cols="40" style="height: 100px; width:100%;"><?php echo $seo_keyword;?></textarea>
                    </div>
                </div>
               <br />
               <div class="clear">
                    ...
                    <div id="post_container" class="clearfix">
                        <!-- 내용 -->
                        <textarea id="seo_description" name="seo_description" cols="40" style="height: 100px; width:100%;"><?php echo $seo_description;?></textarea>
                    </div>
                </div>
				 <br />
				<div class="clear">
                     ...
                     <div id="post_container" class="clearfix">
                         <textarea id="seo_og_title" name="seo_og_title" cols="40" style="height: 100px; width:100%;"><?php echo $seo_og_title;?></textarea>
                     </div>
                </div>
				 <br />
				<div class="clear">
                     ...
                     <div id="post_container" class="clearfix">
                         <textarea id="seo_og_description" name="seo_og_description" cols="40" style="height: 100px;width:100%;"><?php echo $seo_og_description;?></textarea>
                     </div>
                </div>
				 <br />
...
$(document).ready(function() {
	...
	$(".company_interviews_tag").autocomplete(data_value).result(function(){
			...
			//var seo_description=title+"の"+$('.subject_company_interview').val()+"に関するインタビュー";
			var seo_description=title+"の"+$('.subject_company_interview').val()+"に関するインタビューです。";
			$('#seo_description').val(seo_description);
			$("#seo_keyword").val("ヘッド,ハンティング,転職,支援,人材,紹介,30代,コンサルティング,コラム,キャリア,"+$('.subject_company_interview').val());
			
			
			$(".subtitle_company").val(company_interviews_subtile);
			$('#seo_og_title').val(company_interviews_subtile);
			...
			$('#seo_og_description').val(company_interviews_description);
