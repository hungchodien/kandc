<?php 
	...
	$id_f=$_GET['id'];
		...
		{
			$List = Get_Data("category_mailmagazine", "and category_mailmagazine_ID = $id_f");
			$op_vis_str = ($List['category_mailmagazine_Status'] == "0") ? "Public" : "Draft";
			$op_vis = $List['category_mailmagazine_Status'];
			$title = $List['category_mailmagazine_Name'];
			...
			$thumbnail= $List['category_mailmagazine_Thumbnail'];
			list($op_front, $op_bottom) = explode(" ", $List['category_mailmagazine_Date']);
	...
	<div id="content_body" class="fl">
		<div id="post_body" class="clearfix">
			<div id="post_body_content">
            	<div class="clear">
            	 <p class="title_txt">Name Category Mail Magazine</p>
				<input id="post_title" type="text" name="category_mailmagazine_Name" value="<?php echo $title;?>" />
                </div>
                <div class="clear">
