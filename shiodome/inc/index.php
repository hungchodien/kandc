...
<div id="about">
    <div class="about_wrapper">
        ...
        <p class="about_txt">「汐留アカデミー」とは、毎回各分野でご活躍されているプロフェッショナルな方々を講師としてお招きし　Input　と　Networking　によって挑戦への熱量を高めていただく、クライス＆カンパニー主催のキャリアイベントです。
<br /><br />
イベント前半部は、講師の方の転機にまつわるエピソードや、生き方のポリシー、成果を出す秘訣などをお聞きし、皆さまに　Input　いただくお時間です。そして後半部は、講師の方々や参加者の皆さま同士がご交流いただく　Networking　の場とさせていただき、セミナー＆交流会という形式で毎回開催いたします。</p>
        </div>
    </div>
</div><!--About-->
