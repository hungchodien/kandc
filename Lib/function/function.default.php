...
function is_home(){
	 $currentpage_check = $_SERVER['REQUEST_URI'];
        ...
        if($currentpage_check=="/" || $currentpage_check=="/index.php" || $currentpage_check=="" ):
        	return true;
        else:
			return false;
		endif;
}
function is_staticPage($name){
	 $currentpage_check = $_SERVER['REQUEST_URI'];
	
        if($currentpage_check=="/".$name || $currentpage_check=="/".$name."index.php" || $currentpage_check=="/".$name."/" ):
        	return true;
        else:
			return false;
		endif;
}
function is_findPage($name){
	 $currentpage_check = $_SERVER['REQUEST_URI'];
	if (false !== strpos($currentpage_check,$name)):
		return true;
	 else:
	  	return false;
	endif;
...
function is_home_mobile(){
	 $currentpage_check = $_SERVER['REQUEST_URI'];
	
        if($currentpage_check=="/mobile/" || $currentpage_check=="/mobile/index.php" || $currentpage_check=="/mobile" ):
        	return true;
        else:
			return false;
		endif;
