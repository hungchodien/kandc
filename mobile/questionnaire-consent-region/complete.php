    ...
    <script src="<?php echo url_root; ?>js/validate_form_entry.js" type="text/javascript"></script>
       ...
       <!--****************************************************-->
               ...
               <div class="bg_white content_inside block_content" style="margin-top:10px;">
                    ...
                    <h1 class="title">「ご利用に関する注意事項承諾書（地方勤務に関して）」をお送りいただきましてありがとうございます。<br /><br />今後は、担当のコンサルタントが転職支援、キャリアコンサルティングをさせていただきます。<br />
何かご不明な点等ございましたら担当のコンサルタント、もしくは事務局まで何なりとご連絡ください。<br><br></h1>
