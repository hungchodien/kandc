...
?>
    ...
    <div class="title_page clear">
        ...
        <img src="../img/bg-entry.png" alt="エントリー 背景" />
        </div>
     </div>
      ...
      <form id="submit_form" method="post" action="confirm.php">
		...
		?>
            ...
            <div class="bg_white content_inside block_content">
                ...
                <div class="group_txt_form clear select_wrap">
                ...
                <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                    	<div class="input_60_n l clear">
                            <div class="input_50 l">
                                <input type="tel" onblur="validatetext(this.value, this.id)" onfocus="click_text(this.id)" value="" id="text5" name="text5">
                            </div>
                            <div class="input_50 r">
                             <input type="tel" onblur="validatetext(this.value, this.id)" onfocus="click_text(this.id)" value="" id="text6" name="text6">
                            </div>
                        </div>
                         <div class="input_30_n r">
                       	<input type="tel" onblur="validatetext(this.value, this.id)" onfocus="click_text(this.id)" value="" id="text7" name="text7">
                        </div>
                    </div>
                ...
                <div class="group_txt_form last_child clear email_wrap fix_height_form_input">
                	<div class="clear title_txt">メールアドレス<span class="notice">(必須）</span></div>
                    <div class="clear input_form fix_height_form_input">
             ...
             <div class="bg_white content_inside block_content">
                ...
                <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                        ...
                        <div class="input_80 r">
                       	<input type="text" onfocus="click_text(this.id)" value="" id="text22" name="text22">
                        </div>
             ...
             <div class="bg_white content_inside block_content">
                ...
                <div class="group_txt_form clear textarea_wrap">
