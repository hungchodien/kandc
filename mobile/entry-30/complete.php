...
cid = '4T5ZVtUs'; pid = 'SP_entory_30seconds'; m1id='<?php echo $m1id; ?>'; a1id=''; o1id='<?php echo $_POST['o1id']; ?>'; o2id='<?php echo $_POST['o2id']; ?>'; o3id='<?php echo $_POST['o3id']; ?>'; o4id='<?php echo $_POST['o4id']; ?>'; o5id='<?php echo $date_curent; ?>';
...
<img src="//ac.ebis.ne.jp/log.php?argument=4T5ZVtUs&ebisPageID=SP_entory_30seconds&ebisMember=&ebisAmount=&ebisOther1=&ebisOther2=&ebisOther3=&ebisOther4=&ebisOther5=" width="0" height="0">
</noscript>
<!-- EBiS tag end -->
<?php 
		endif;
