...
内容をご確認いただき、ご承知いただきましたら各項目のチェックボックスにチェックした上でご署名をお願いいたします。</p>
       </div>
    ...
    <div class="group_txt_form clear table-personal-profile2">
     ...
     <div class="group_txt_form clear table-personal-profile2">
                    ...
                    <div class="clear input_form">
                        ...
                        <div class="input_100" style="margin-top: 5px">
                            <input class="text-personal-400" type="text" id="text9" name="text9"  onfocus="click_text(this.id)" value="" placeholder="確認のためもう一度ご入力ください。" onblur="IsEmail(this.value,this.id)"  onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off/>
                        </div>
                        <div class="clear">
