...
function To_Send_Mail_F($fname, $fmail, $to, $subject, $content, $type=1, $file="", $cc="", $bcc="", $charset="iso-2022-jp"){
   ...
   $header .= "MIME-Version: 1.0\r\n";
    ...
    if ($file != ""){
		...
		if($count_file==1){
			...
			$header .= "--$boundary\r\n";
			$header.= "Content-Type: application/octet-stream; name=\"".mb_convert_encoding($filename,"ISO-2022-JP","AUTO")."\"\r\n";
			$header .= "Content-Transfer-Encoding: base64\r\n";
			$header .= "Content-Disposition: attachment; filename=\"".mb_convert_encoding($filename,"ISO-2022-JP","AUTO")."\"\r\n\r\n";
			$header .= $filecontent."\r\n\r\n";
