...
<div class="main_top inside">
  ...
  <div id="entry_short_btn" class="entry_btn_top"><a href="#headhunter_short_form"><img alt="エグゼクティブのための転職サポートを受ける" src="<?php echo url_root_headhunter; ?>img/main-entry-button.png" /></a></div>
  </div>
  ...
  <p class="features02_btn features_btn"><img alt="特長02 ベテランコンサルタントがサポート" src="<?php echo url_root_headhunter; ?>img/features-button-2.png" /></p>
...
<div class="headhunter_entry_title center"><img alt="今すぐ転職をお考えの方も、将来的な転職を視野に入れている方もエグゼクティブのための転職サポートにエントリーしてみませんか？＜完全無料＞" src="<?php echo url_root_headhunter; ?>img/entry-title.png" /></div>
<div class="wrapper">
