	...
	jQuery(document).ready(function($){
		...
		$('#main').width(stepsWidth);
		 ...
		 $(".step .button-back").delegate("a.back_pre","click", function(e){
			 	var data_step=$(this).closest('.step').attr('data-tag');
				var pre=parseInt(data_step)-1;
			    var width_total=$('#wrapper_container_group').width();
				var current_marginleft=parseInt($("#main").css("marginLeft"))+width_total;
				console.log("marginleft:"+current_marginleft);
				$('#main').stop().animate({
					marginLeft: + current_marginleft + 'px'
				},500,function(){
...
<div id="wrapper_container_group" class="clear wrapper_container_group">      
    ...
    <div id="main" class="container_entry_ld step_form_main clear">         
        ...
        <div id="step1" data-tag="1" class="step clear <?php if(!empty($_POST)): echo "display_none"; else: echo "display_block"; endif; ?>">
            ...
            <li class="a_check"><a href="#">まあ満足</a></li>
            </ul>
            <ul class="clear">
            <li><a href="#">普通</a></li>
        ...
        <div id="step2" data-tag="2" class="step clear <?php if(!empty($_POST)): echo "display_none"; else: echo "display_block"; endif; ?>">
            ...
            <ul class="clear">
            <li><a href="#">ある</a></li>
            <li class="a_check"><a href="#">ない</a></li>
            </ul>
            </div>
        ...
        <div id="headhunter_short_form" class="headhunter_form_content inside step clear" style="<?php if(!empty($_POST)): echo 'display:block;'; endif; ?>">
            <div class="grau_bg">
                  ...
                  <!--End Content -->    
                   ...
                   <!--****************************************************-->
                    ...
                    <form id="submit_form" method="post" action="">	
                        <input type="hidden" id="step_input1" value="" name="step_input1" autocomplete="off"/>
                        <input type="hidden" id="step_input2" value="" name="step_input2" autocomplete="off"/>
                        <input type="hidden" id="step_input3" value="" name="step_input3" autocomplete="off"/>
                    <?php 
