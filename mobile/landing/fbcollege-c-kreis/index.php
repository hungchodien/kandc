...
<div class="main_top inside">
  ...
  <h2 class="main_title"><img alt="一流大学卒のあなたへ" src="<?php echo url_root_headhunter; ?>img/main-title.png" /></h2>
...
<p>求人サイトではなかなかピンとくる求人をみつけることができず、クライス＆カンパニーの担当者と面談。自分の志向や気持ちを詳しくお話ししたたところ、事業理念やビジョンが私にマッチするのではと、ある企業をご紹介いただき、すぐに社長と面接、意気投合し、転職という流れになりました。</p>
</div>
