...
" />
<meta PROPERTY="og:image" content="http://www.kandc.com/mobile/img/kreis-company-landing-og.png" />
...
jQuery(document).ready(function($){
	...
	$('.sub_entry_button_30 a').click(function () {
		$('body,html').animate({
			scrollTop: $('#bottom-banner').offset().top
		}, 800);
		return false;
	});
...
<script type="text/javascript">
        	jQuery(document).ready(function($){
				...
				$(".back_from_confirm a").click(function(){
