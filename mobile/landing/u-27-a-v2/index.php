...
<script type="text/javascript" src="<?php echo url_root_headhunter; ?>js/jquery.waypoints.min.js"></script>
...
jQuery(document).ready(function($){
	...
	//waypoint
	$('#headhunter_short_form').waypoint(function( direction ){
					if( direction == 'down'){
						$('#entry_fixed_btn').removeClass('btn_on');
						$('#entry_fixed_btn').addClass('btn_off');
					} else {
						$('#entry_fixed_btn').removeClass('btn_off');
						$('#entry_fixed_btn').addClass('btn_on');
					}
				}, {offset:function(){
...
<div class="main_top inside">
  <p class="main_img"><img alt="年収1000万円超ハイクラスキャリアを目指す20代へ　専属キャリアコンサルタントに相談してみませんか？　クライスU-27 相談受付開始　1-20代のうちに、もっと幅広い経験が積みたい 2-本当にやりたい仕事に、今こそ挑戦したい　3-漠然と不安を感じているが、転職するべき？" src="<?php echo url_root_headhunter; ?>img/top_img.jpg" /></p>
  
  <?php /*?><div class="main_title_group">
  <div class="wrapper">
  ...
  <div id="entry_fixed_btn" class="entry_btn_fix btn_on">
  <div class="inside">
  <div id="entry_short_btn"><a href="#headhunter_short_form"><img alt="無料でキャリアコンサルタントに相談する" src="<?php echo url_root_headhunter; ?>img/entry-button-v2.png" /></a></div>
  </div>
  </div>
  
  <div class="inside">
 <div class="reason blue_bg">
 <div class="wrapper">
 <div class="reason_content">
 <p class="ghim"><img alt="クリップ" src="<?php echo url_root_headhunter; ?>img/ghim.png" /></p>
...
<div class="step_head">
<img alt="" src="<?php echo url_root_headhunter; ?>img/step_title_bg.png" alt="クライス＆カンパニーキャリアコンサルタントの3つの強み"/>
</div>
...
<div class="wrapper"><div class="box"><p>クライスのキャリアコンサルタントは、国家資格を持つプロです。<br />
まずはあなたのお気持ちをしっかりヒアリングし、きちんと理解した上で可能性を最大限に広げられるような提案をいたします。</p></div></div>
</div>
<div class="step_block step_block3">
<h4 class="title">ヘッドハンティング会社だから、<br />
求人情報ありきではなく理想的な転職先を探すことが可能です。</h4>
<div class="wrapper"><div class="box"><p>元々、ヘッドハンティングをメインとしてスタートした当社。創業以来、24年間で培った企業との太いパイプがあるので、当社だけの独占ルート求人のご紹介や、候補者の方に合わせた新規ポジションをお探しする事も可能です。</p></div></div>
</div>
</div>

<div class="voice inside grau_bg">
...
<a href="http://www.kandc.com/profile/" target="_blank">企業情報</a>　<a href="http://www.kandc.com/privacy_policy/" target="_blank">個人情報保護方針</a>
       ...
       <p class="copyR">株式会社クライス＆カンパニー<br>
〒105-0021 東京都港区東新橋2-4-1　サンマリーノ汐留2F<br>TEL 03-5733-1602<br>
<a href="mailto:kreis-info@kandc.com">kreis-info@kandc.com</a></p>
