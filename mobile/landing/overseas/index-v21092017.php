				...
				<div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                    	<div class="input_80 l">
                       	  <input type="number" value="<?php if(!empty($_POST)): echo $_POST['text15']; endif; ?>" id="text15" name="text15" onfocus="click_text(this.id)" placeholder="" style="ime-mode:disabled;" pattern="[0-9]*"/>
                        </div>
