	...
	if($('#select1 option:selected').val() == '' && $('#select2 option:selected').val() == '' && $('#select3 option:selected').val() == '' )
		...
		{	
           ...
           if( !isValidEmailAddress($('#text8').val()))
            ...
            if ($('#text13').val() == '') {
                $('#errorselect13').text($errorText);
                $('#errorselect13').addClass('error');
			...
			if ($re1 == false || $re3 == false || $re5 == false || $re6 == false || $re7 == false || $re9 == false  || $re10 == false || $re12 == false || $re13 == false || $re14 == false || $re15 == false || $re16 == false)
			{
				scroll_top_id();
                return false;
            }
