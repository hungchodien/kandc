...
<meta PROPERTY="og:title" content="一流のキャリアコンサルタントが年収750万円以上の転職をお手伝い　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー" />
<meta PROPERTY="og:type" content="website" /> 
<meta PROPERTY="og:url" content="https://kandc.com/mobile/landing/affiliate-v4/" /> 
...
<title>一流のキャリアコンサルタントが年収750万円以上の転職をお手伝い　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー</title>
...
<div class="main_top inside">
  <p class="main_img"><img alt="一一流のキャリアコンサルタントが年収750万円以上の転職をお手伝い マネージャー～経営幹部へステップアップできる, 年収800万～2000万、希少なハイクラス求人に出会える, 生の企業情報が聞けるから価値観にマッチした会社を探せる" src="<?php echo url_root_headhunter; ?>img/main-bg.png" /></p>
  
  <div class="main_title_group">
  <div class="wrapper">
  
  <div id="entry_short_btn" class="entry_btn_top"><a href="#headhunter_short_form"><img alt="自分の市場価値を聞く(無料)" src="<?php echo url_root_headhunter; ?>img/main-entry-button.png" /></a></div>
  </div>
  </div>
  </div>
...
<p class="sub_entry_button_30"><a href="#headhunter_short_form"><img alt="30代転職に強いコンサルタントに相談する(無料)" src="<?php echo url_root_headhunter; ?>img/entry-button-reason-1.png" /></a></p>
...
<p class="sub_entry_button_30"><a href="#headhunter_short_form"><img alt="非公開・独占案件を紹介してもらう(無料)" src="<?php echo url_root_headhunter; ?>img/entry-button-reason-2.png" /></a></p>
<p class="sub_entry_note">※ご経験・ご希望によっては、ご紹介できる求人がなく、当社でのサポートが難しい場合がございます。</p>
  </div>
  </div>
...
<p class="sub_entry_button_30"><a href="#headhunter_short_form"><img alt="自分の新たな可能性が知りたい(無料)" src="<?php echo url_root_headhunter; ?>img/entry-button-reason-3.png" /></a></p>
<p class="sub_entry_note">※ご経験・ご希望によっては、ご紹介できる求人がなく、当社でのサポートが難しい場合がございます。</p>
  </div>
  </div>
