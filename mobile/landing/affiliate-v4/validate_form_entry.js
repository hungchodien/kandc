	...
	if($('#select1 option:selected').val() == '' && $('#select2 option:selected').val() == '' && $('#select3 option:selected').val() == '' )
		...
		{	
           ...
           if ($('#text18').val() == '') {
			...
			if ($re1 == false || $re2 == false || $re3 == false || $re4 == false || $re5 == false || $re6 == false || $re7 == false || $re9 == false  || $re12 == false || $re14 == false || $re15 == false || $re17 == false || $re16 == false || $re19 == false || $re20 == false)
			{
				scroll_top_id();
                return false;
            }
