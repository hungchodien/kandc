<?php include('inc/header.php');?>
         ...
         <div id="primary" class="index inside">
         		<section class="main-banner <?php echo (!empty($_POST)) ? 'display_none' :'display_block'; ?>">
                		<img src="<?php echo url_root_headhunter; ?>img/main-banner.png" alt="" />
                        <img class="banner-title" src="<?php echo url_root_headhunter; ?>img/banner-title.png" alt="専属ヘッドハンターと一緒にあなたのネクストキャリア切り開きませんか？" />
                        <img class="banner-sub" src="<?php echo url_root_headhunter; ?>img/banner-sub.png" alt="コンサル業界担当ヘッドハンター 入江 祥之" />
                </section>
                
                <section class="targets <?php echo (!empty($_POST)) ? 'display_none' :''; ?>">
                		
                        <div class="target">
                        		<img src="<?php echo url_root_headhunter; ?>img/target-01.png" alt="独立起業を目指しているので事業会社で経営の経験を積みたい" />
                        </div>
                        <div class="target">
                        		<img src="<?php echo url_root_headhunter; ?>img/target-02.png" alt="今の会社では目標をクリアしたのでそろそろ次のキャリアを考えたい" />
                        </div>
                       <div class="target">
                       			<img src="<?php echo url_root_headhunter; ?>img/target-03.png" alt="信頼できる転職ネットワークを持っていたい" />
                        </div>
						<div class="sub_entry_button_30 btn center">
                        	<a href="#" class=""><img src="<?php echo url_root_headhunter; ?>img/entry-part-btn.png" alt="無料でヘッドハンターに相談してみる" /></a>
                        </div>
                        <div class="pen">
                        		<img src="<?php echo url_root_headhunter; ?>img/pen.png" />
                        </div>
                </section>
                
                <section class="reasons <?php echo (!empty($_POST)) ? 'display_none' :'display_block'; ?>">
                			<div class="lbl center"><img src="<?php echo url_root_headhunter; ?>img/the-reason-lbl.png" alt="クライス＆カンパニーがポストコンサルのキャリアに強い3つの理由" /></div>
                            <div class="list">
                            		<article class="reason">
                                    		<div class="title">
                                            	<img src="<?php echo url_root_headhunter; ?>img/reason-01.png" alt="その1 ポストコンサル転職案件数No.1だから可能性がぐっと広がります。" />
                                            </div>
                                            <div class="desc">
                                            		あなたの大切なネクストキャリア。妥協したくないなら豊富な選択肢が必須です。幅広い可能性の中からあなたにとってベストなポジションを見つけ出しませんか？
                                            </div>
                                    </article>
                                    <article class="reason">
                                    		<div class="title">
                                            	<img src="<?php echo url_root_headhunter; ?>img/reason-02.png" alt="その2 コンサル業界出身者が専属で担当。だから的確なサポートが受けられます。" />
                                            </div>
                                            <div class="desc">
                                            		コンサルタント業界と転職市場を熟知したヘッドハンターがサポート。あなたのコンサル経験を最大限に活かせる次のステージ探しを力強くバックアップします。
                                            </div>
                                    </article>
                                    <article class="reason">
                                    		<div class="title">
                                            	<img src="<?php echo url_root_headhunter; ?>img/reason-03.png" alt="その3 ヘッドハンティング会社だから他では出会えない求人情報が見つかる" />
                                            </div>
                                            <div class="desc">
                                            		創業24年目。長い時間をかけて培った企業との太いパイプにより、当社だけの独占ルート求人のご紹介や、候補者の方に合わせた新規ポジションの開拓を可能にしています。
                                            </div>
                                    </article>
                            </div><!--list-->
                            <div class="btn sub_entry_button_30">
                            		<a href="#"><img src="<?php echo url_root_headhunter; ?>img/entry-part-btn.png" alt="専属ヘッドハンターに相談してみる" /></a>
                            </div>
                </section>
                
                <section class="jobs <?php echo (!empty($_POST)) ? 'display_none' :'display_block'; ?>">
                		<div class="job">
                        		<div class="tmb"><img src="<?php echo url_root_headhunter; ?>img/person-01.png" /></div>
                                <div class="title clear">
                                		<h3 class="left">経営戦略コンサルタント</h3>
                                        <div class="arrow"><img src="<?php echo url_root_headhunter; ?>img/arrow.png" /></div>
                                        <h4 class="right">WEB系企業事業責任者</h4>
                                </div>
                                <div class="salary center">年収1500万</div>
                                <div class="content">
                                		<div class="img-title"><img src="<?php echo url_root_headhunter; ?>img/job-title-01.png" alt="早めの行動が吉でした。" /></div>
                                        <p class="text">
                                        		はじめて専属ヘッドハンターとお会いしたのは2年前。転職する同期も出始め、自分もそろそろ次のキャリアを考えた方がいいのかなという思いから、ヘッドハンターにコンタクトしてみました。その後、納得のいく求人を時間をかけて探していくことに。数か月後、WEBサービスを展開する外資系企業が日本進出にあたり事業責任者候補の採用を考えているとの情報をいただき、絶好のチャンスだと感じ即応募。結果、条件面も申し分なく採用となり現在は事業責任者として活躍中です。早めの行動が吉だったと強く感じています。
                                        </p>
                                </div>
                        </div>
                        
                        <div class="job">
                        		<div class="tmb"><img src="<?php echo url_root_headhunter; ?>img/person-02.png" /></div>
                                <div class="title clear">
                                		<h3 class="left">経営戦略コンサルタント</h3>
                                        <div class="arrow"><img src="<?php echo url_root_headhunter; ?>img/arrow.png" /></div>
                                        <h4 class="right">ベンチャー企業経営幹部候補</h4>
                                </div>
                                <div class="salary center">年収1000万</div>
                                <div class="content">
                                		<div class="img-title"><img src="<?php echo url_root_headhunter; ?>img/job-title-02.png" alt="あいまいな条件の中で、フィット感の高い企業に出会えました。" /></div>
                                        <p class="text">
                                        		自分自身で事業に携わりたいとの思いが強くなり、転職を考え始めたタイミングでヘッドハンターにお会いしました。心から共感できるビジネスに全力で携わりたいとの気持ちをお伝えしたところ、独自の面白いビジネスモデルを持つベンチャー企業の紹介を受けました。面接で経営者の想いや自分への期待など、率直な気持ちを聞く中で、気持ちが高まり転職を決意。共感というあいまいな条件の中でフィット感の高い企業を見つけていただけた事に感謝しています。
                                        </p>
                                </div>
                        </div>
                        ...
                        <div class="job">
                        		<div class="tmb"><img src="<?php echo url_root_headhunter; ?>img/person-03.png" /></div>
                                <div class="title clear">
                                		<h3 class="left">経営戦略コンサルタント</h3>
                                        <div class="arrow"><img src="<?php echo url_root_headhunter; ?>img/arrow.png" /></div>
                                        <h4 class="right">PEファンド投資担当</h4>
                                </div>
                                <div class="salary center">年収1200万</div>
                                <div class="content">
                                		<div class="img-title"><img src="<?php echo url_root_headhunter; ?>img/job-title-03.png" alt="独自ルートのおかげで希望通りの転職が叶いました。" /></div>
                                        <p class="text">
												転職先としてPEファンドを希望しており、既に数社の面接を受けたもののなかなか採用にいたらず、有力な採用ルートを探していました。こちらのヘッドハンターに相談したところ、ある会社を紹介され、順調に面接、採用に。希少性の高い求人に出会う事ができたのは、専属ヘッドハンターの独自ルートあっての事。希望通りの転職が叶い大変満足しています。                                        		
                                        </p>
                                </div>
                        </div>
...
<section class="success_story blue_bg wrapper <?php echo (!empty($_POST)) ? 'display_none' :'display_block'; ?>">
<h3><img src="<?php echo url_root_headhunter; ?>img/success-story-title.png" alt="ポストコンサル転職 成功事例" /></h3>
<div class="success_story_content white_bg">
<table>
<tr>
<td class="age_col">35歳</td>
<td class="plan_col">Web系ベンチャー 事業企画</td>
<td class="income_col">/ 年収1400万円</td>
</tr>
<tr>
<td class="age_col">33歳</td>
<td class="plan_col">大手企業 全社改革リーダー</td>
<td class="income_col">/ 年収1350万円</td>
</tr>
<tr>
<td class="age_col">43歳</td>
<td class="plan_col">ヘルスケア系企業 社長候補</td>
<td class="income_col">/ 年収1800万円</td>
</tr>
<tr>
<td class="age_col">34歳 </td>
<td class="plan_col">メガバンク 新規ビジネス企画</td>
<td class="income_col">/ 年収1400万円</td>
</tr>
<tr>
<td class="age_col">39歳</td>
<td class="plan_col">医療系Webサービス 事業開発</td>
<td class="income_col">/ 年収2500万円</td>
</tr>
<tr>
<td class="age_col">31歳</td>
<td class="plan_col">PEファンド 投資担当</td>
<td class="income_col">/ 年収1000万円</td>
</tr>
<tr>
<td class="age_col">41歳</td>
<td class="plan_col">ヘルスケア系企業 経営幹部</td>
<td class="income_col">/ 年収2500万円</td>
</tr>
<tr>
<td class="age_col">48歳</td>
<td class="plan_col">大手EC 事業責任者</td>
<td class="income_col">/ 年収2500万円</td>
</tr>
<tr>
<td class="age_col">35歳</td>
<td class="plan_col">自動車メーカー 経営企画</td>
<td class="income_col">/ 年収1300万円</td>
</tr>
<tr>
<td class="age_col">42歳</td>
<td class="plan_col">一部上場企業 経営幹部候補</td>
<td class="income_col">/ 年収1800万円</td>
</tr>
<tr>
<td class="age_col">33歳</td>
<td class="plan_col">外資系EC 事業企画</td>
<td class="income_col">/ 年収1300万円</td>
</tr>
<tr>
<td class="age_col">39歳</td>
<td class="plan_col">大手Webサービス 経営企画</td>
<td class="income_col">/ 年収1500万円</td>
</tr>
<tr>
<td class="age_col">42歳</td>
<td class="plan_col">大手EC 事業企画</td>
<td class="income_col">/ 年収1800万円</td>
</tr>
</table>
<p align="right" style="font-size:10px; padding-top:10px;">※ご登録者には更に詳しい実例もお伝えします。</p>
</div>

</section>
                
                <section id="bottom-banner" class="bottom-banner">
                			<img src="<?php echo url_root_headhunter; ?>img/bottom-banner.png" alt="" />
                            <img class="title" src="<?php echo url_root_headhunter; ?>img/bottom-banner-title.png" alt="転職成功者続出中！まずはヘッドハンターにコンタクトしてみませんか？" />
                            <img class="sub" src="<?php echo url_root_headhunter; ?>img/bottom-banner-sub.png" alt="コンサル業界担当ヘッドハンター 永田 憲章" />                            
                </section>
                <div id="test" style="display:none"><?php print_r($_POST);?></div>
         </div>

         
<div id="headhunter_short_form" class="headhunter_form_content inside blue_bg">
...
<div class="wrapper">
      ...
      <!--End Content -->    
       ...
       <!--****************************************************-->
       <div class=" clear top_share_mail">
			<?php 
