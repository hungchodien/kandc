...
<meta PROPERTY="og:url" content="http://kandc.com/mobile/landing/" /> 
...
$protocol = strpos(strtolower($_SERVER['SERVER_PROTOCOL']),'https') 
			...
			define('url_root',$protocol."//".$_SERVER["SERVER_NAME"].'/mobile/landing/');
...
<script type="text/javascript" src="<?php echo url_root_http; ?>js/number_check.js"></script>
<script type="text/javascript" src="<?php echo url_root_http; ?>js/common_funcs.js"></script>
...
<header>
    ...
    <div id="logo"><a href="<?php echo $protocol;?>//kandc.com/"><img title="ヘッドハンティングのクライス＆カンパニー" alt="ヘッドハンティングのクライス＆カンパニー" src="<?php echo url_root;?>img/logo.png" /></a></div>
