...
<meta PROPERTY="og:title" content="30代、早慶東大卒 いつかは転職とお考えのあなたへ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー" />
...
<meta PROPERTY="og:site_name" content="30代、早慶東大卒 いつかは転職とお考えのあなたへ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー" />


<title>30代、早慶東大卒 いつかは転職とお考えのあなたへ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー</title>
...
<div class="main_top inside">
  <p class="main_img"><img alt="完全無料 マネージャー～経営幹部へステップアップできる, 年収1000万～4000万希少なハイクラス求人に出会える, 生の企業情報が聞けるから価値観にマッチした会社を探せる 2017年の転職成功を応援！" src="<?php echo url_root_headhunter; ?>img/main-bg-okada.png" /></p>
  
  <div class="main_title_group">
  <div class="wrapper">
  
  <div class="main_top_txt">
  <h2 class="main_title"><img alt="30代、早慶東大卒 いつかは転職とお考えのあなたへ ヘッドハンターのリストへエントリーしませんか？" src="<?php echo url_root_headhunter; ?>img/main-title.png" /></h2>
 
  </div>
  
  <p class="sign">エグゼクティブコンサルタント 岡田麗</p>
  <div id="entry_short_btn" class="entry_btn_top"><a href="#headhunter_short_form"><img alt="ヘッドハンターのリストへ登録する" src="<?php echo url_root_headhunter; ?>img/main-entry-button.png" /></a></div>
  </div>
  </div>
  </div>
  ...
  <h3 class="reason_box_title"><img alt="国家資格保有者の圧倒的コンサルティング力であなたの強みを最大限に引き出します。" src="<?php echo url_root_headhunter; ?>img/reason01-title.png" /></h3>
  ...
  <h3 class="reason_box_title"><img alt="24年の歴史で培った企業との強固なパイプにより一般に出回らない求人の紹介が可能です。" src="<?php echo url_root_headhunter; ?>img/reason02-title.png" /></h3>
  ...
  <h3 class="reason_box_title"><img alt="今すぐの転職を考えていない方でも5年後、10年後を見据え、長期的にサポート。魅力的なチャンスを逃しません。" src="<?php echo url_root_headhunter; ?>img/reason03-title.png" /></h3>
  <p>ステップアップ転職には、タイミングが重要。魅力的なチャンスを逃さないよう、専属ヘッドハンターが長期的にサポートし、タイムリーに情報提供いたします。</p>
  </div>
  
  <p class="gcdf sub_entry_button_30">
  <a href="#headhunter_short_form"><img alt="無料転職サポートに申し込む" src="<?php echo url_root_headhunter; ?>img/sub-entry-button.png" /></a>
  </p>
