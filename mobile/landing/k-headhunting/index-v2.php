...
<meta PROPERTY="og:title" content="ヘッドハンティング転職で本気のキャリアアップを実現したいあなたへ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー" />
<meta PROPERTY="og:type" content="website" /> 
<meta PROPERTY="og:url" content="https://kandc.com/mobile/landing/k-headhunting/" /> 
...
<meta PROPERTY="og:site_name" content="ヘッドハンティング転職で本気のキャリアアップを実現したいあなたへ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー" />


<title>ヘッドハンティング転職で本気のキャリアアップを実現したいあなたへ　ヘッドハンティング・人材紹介・転職支援ならクライス＆カンパニー</title>
...
<div class="main_top inside">
  ...
  <h2 class="main_title"><img alt="ヘッドハンティング転職で本気のキャリアアップを実現したいあなたへ" src="<?php echo url_root_headhunter; ?>img/main-title.png" /></h2>
            ...
            <div class="page1 bg_white content_inside block_content">
                ...
                <div class="group_txt_form group_txt_form_end clear">
                 ...
                 <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                    	<div class="input_50 l">
                       	  <input type="number" min="1" value="<?php if(!empty($_POST)): echo $_POST['text17']; endif; ?>" id="text17" name="text17" onfocus="click_text(this.id)" placeholder="" style="ime-mode:disabled;" pattern="[0-9]*"/>
                        </div>
    ...
    <!--Confirm form-->
     ...
     <!--End Content -->    
       ...
       <?php
			...
			?>
       	<form id="confirm_form" name="frm_confirm" method="post" action="send_mail.php" autocomplete="off">
        <?php
			echo $prev_input;
			echo $prev_input1;
			echo $prev_radio;
