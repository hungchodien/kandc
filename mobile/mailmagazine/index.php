...
`A`.`excerpt_career_up`,`B`.`consultant_Thumb`,`A`.`consultant_add_thumbnail_index`,`B`.`consultant_Name`,`B`.`position_cp`,`B`.`consultant_ID`");
            ...
            <div class="fill-email">
                <table>
                    <tbody><tr>
                        ...
                        <td>
                            <input type="email" class="email-input" name="email" placeholder="半角文字でお間違いのないようご入力ください" value="" id="text8">

                            <input style="margin-top: 5px" type="email" class="email-input" name="email_conform" placeholder="確認のためもう一度ご入力ください。" value="" id="text9"
                                   inputmode="verbatim" style="ime-mode:inactive;" onselectstart="return false" onpaste="return false;"
                                   onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off/>

                            <div class="clear">
                                <span id="errortext89" class="error_mailmagazine"></span>
                            </div>
                        </td>
                    </tr>
                    </tbody></table>
        ...
        <script>
            jQuery(document).ready(function($) {
                ...
                ///hungtt add no copy cut paste date : 21/09/2017
                ...
                ////// end hungtt add no copy cut paste date : 21/09/2017
