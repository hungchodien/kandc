...
<?php 
	...
	?>
            ...
            cid = '4T5ZVtUs'; a1id=''; pid = 'SP_entory_pre'; m1id='<?php echo $m1id; ?>'; o1id='<?php echo $_POST['o1id']; ?>'; o2id='<?php echo $_POST['o2id']; ?>'; o3id='<?php echo $_POST['o3id']; ?>'; o4id='<?php echo $_POST['o4id']; ?>'; o5id='<?php echo $date_curent; ?>';
            (function() {
            ...
            <noscript>
                <img src="https://ac.ebis.ne.jp/log.php?argument=4T5ZVtUs&ebisPageID=SP_entory_pre&ebisMember=&ebisAmount=&ebisOther1=&ebisOther2=&ebisOther3=&ebisOther4=&ebisOther5=" width="0" height="0">
            </noscript>
            <!-- EBiS tag end -->
    <?php 
		endif;
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt="" src="//b91.yahoo.co.jp/pagead/conversion/1000377546/?value=0&label=NLB1CJDu9W4Q26TTmQM&guid=ON&script=0&disvt=true"/>
    </div>
</noscript>
