		...
		?>
                ...
                <div class="clear input_form">
                    <div class="input_100">
                        ...
                        <select onfocus="click_text(this.id)" onblur="validateSelect(this.value, this.id)" id="select13" name="select13" class="selection">
                            ...
                            <option <?php if($select10_sl=='3ヶ月～6ヶ月'):?> selected="selected"  <?php endif; ?> value="3ヶ月～6ヶ月">3ヶ月～6ヶ月</option>
                            <option <?php if($select10_sl=='6ヶ月～1年'):?> selected="selected"  <?php endif; ?> value="6ヶ月～1年">6ヶ月～1年</option>
            ...
            <div class="group_txt_form clear">
                ...
                <div class="group_txt_form clear"  style="margin-top: 0px;">
                    ...
                    <div class="clear input_form">
                        <input type="text" value="<?php if(!empty($_POST)): echo $_POST['text13']; endif; ?>" id="text13" name="text13" onfocus="click_text(this.id)" placeholder="（例）◯◯大学　◯◯学部　◯◯学科" />
                    </div>
                ...
                <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form" style="margin: 15px 0px 0px 0px;">
                        ...
                        <label style="padding-right: 15px;">
                            <input id="radio2" type="radio" value="退職予定" name="radio1">
                            退職予定
                        </label>
                        <label style="padding-right: 15px;">
                            <input id="radio3" type="radio" value="離職中" name="radio1">
                            離職中
                        </label>
                    </div>
                </div><!--End Group txt-->
...
?>        
        ...
        <div class="bg_white content_inside block_content">
                ...
                <div class="group_txt_form clear">
                       ...
                       <div class="clear input_form">
                           <div class="input_100 clear confirm_txt_submit">
                               <p><?php echo $_POST['select7']; ?>年 <?php echo $_POST['select8']; ?>月</p>
