	...
	<script type="text/javascript" src="../../js/common_funcs.js"></script>
      ...
      <!--End Content -->    
       ...
       <div class="title_notice clear top_share_mail">
           <p class="title_top_form yellow clear">プレエントリーフォーム</p>
                <style type="text/css">
       	...
       	<form id="submit_form" method="post" action="">	
            ...
            <div class="group_txt_form clear">
                ...
                <div class="clear input_form">
                    <div class="input_100">
                        <?php if(!empty($_POST)): $select10_sl= $_POST['select13']; endif; ?>
                        <select onfocus="click_text(this.id)" onblur="validateSelect(this.value, this.id)" id="select13" name="select13" class="selection">
                            <option>下記から選択してください</option>
                            <option <?php if($select10_sl=='今すぐ'):?> selected="selected"  <?php endif; ?> value="今すぐ">今すぐ</option>
                            <option <?php if($select10_sl=='3ヶ月以内'):?> selected="selected"  <?php endif; ?> value="3ヶ月以内">3ヶ月以内</option>
                            <option <?php if($select10_sl=='3ヶ月～半年'):?> selected="selected"  <?php endif; ?> value="3ヶ月～半年">3ヶ月～半年</option>
                            <option <?php if($select10_sl=='半年から1年'):?> selected="selected"  <?php endif; ?> value="半年から1年">半年から1年</option>
                            <option <?php if($select10_sl=='良い企業があれば'):?> selected="selected"  <?php endif; ?> value="良い企業があれば">良い企業があれば</option>
                            <option <?php if($select10_sl=='未定'):?> selected="selected"  <?php endif; ?> value="未定">未定</option>
                        </select>
                    </div>

                </div>
                <div class="clear"><span id="errorselect13"></span></div>
            </div><!--End Group txt-->
            ...
            <div class="group_txt_form clear">
                ...
                <div class="clear input_form">
                    <div class="input_100">
                        <textarea  value="" onfocus="click_text(this.id)" id="text19" name="text19" type="text"><?php if(!empty($_POST)): echo $_POST['text19']; endif; ?></textarea>
                    </div>
                </div>
            </div><!--End Group txt-->
            ...
            <div class="group_txt_form clear">
                ...
                <div class="group_txt_form group_txt_form_end clear">
                    ...
                    <div class="clear input_form">
                    	<div class="input_other">
                       		<input type="email" value="<?php if(!empty($_POST)): echo $_POST['text8']; endif; ?>" id="text8" name="text8"  onfocus="click_text(this.id)"  inputmode="verbatim" style="ime-mode:inactive;" placeholder="（例）example@kandc.com"/>
                        </div>
                        <div class="input_other">
                       	 <input type="email"  value="<?php if(!empty($_POST)): echo $_POST['text8']; endif; ?>" id="text9" name="text9" inputmode="verbatim" style="ime-mode:inactive;" onfocus="click_text(this.id)" placeholder="確認のためもう一度ご入力ください。">
                        </div>
                ...
                <div class="group_txt_form clear"  style="margin-top: 0px;">
                    ...
                    <div class="clear"><span  id="errortext23"></span></div>
                </div><!--End Group txt-->
	                        ...
	                        <div class="input_50 r">
	                       	  <select class="selection selection-style" name="select10" id="select10">
	                                ...
	                                for ($moth; $moth <= $endMoth; $moth++) {
	                                    ?>
	                                    <option value="<?php echo $moth ?>"
	                                   <?php if(!empty($_POST)): $select10_da= (int)$_POST['select10']; ?>
	                                    		<?php if($moth==$select10_da): ?>
	                                     			selected="selected"
	                                     		<?php endif; ?>
	                                     	<?php endif; ?> 
                    ...
                    <tr>
                       ...
                       <div class="clear">
                        <?php if(!empty($_POST)): $select12_sl= $_POST['select12']; endif; ?>
                    	 <select id="select12" name="select12"  class="selection from-media">
                ...
                <div class="group_txt_form clear">
                    ...
                    <div class="clear input_form">
                        <div class="input_100 clear confirm_txt_submit">
                            <span><?php echo $_POST['select13'] ?></span>
