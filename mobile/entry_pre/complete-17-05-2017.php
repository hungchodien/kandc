...
<?php 
    ...
    cid = '4T5ZVtUs'; pid = 'SP_entory_pre'; m1id='<?php echo $m1id; ?>'; o1id='<?php echo $_POST['o1id']; ?>'; o2id='<?php echo $_POST['o2id']; ?>'; o3id='<?php echo $_POST['o3id']; ?>'; o4id='<?php echo $_POST['o4id']; ?>'; o5id='<?php echo $_POST['o5id']; ?>';
