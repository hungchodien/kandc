	...
	if($('#select1 option:selected').val() == '' && $('#select2 option:selected').val() == '' && $('#select3 option:selected').val() == '' )
		...
		{	
           ...
           if($('#text9').val() != $('#text8').val())
			...
			if ($('#text23').val() == '') {
                $('#errortext23').text($errorText);
                $('#errortext23').addClass('error');
                $(this).find('#text23').addClass('textError');
                $re18 = false;
            } else {
				$(this).find('#text23').removeClass('textError');
				$("#errortext23").empty();
                $re18 = true;
            }
           ...
           if ($('#text18').val() == '') {
			...
			if ($re1 == false || $re2 == false || $re3 == false || $re4 == false || $re5 == false || $re6 == false || $re7 == false || $re9 == false  || $re12 == false || $re13 == false || $re14 == false || $re15 == false || $re16 == false || $re18 == false || $re19 == false || $re20 == false)
			{
				scroll_top_id();
                return false;
            }
