...
cid = '4T5ZVtUs'; pid = 'SP_entory_pre'; m1id='<?php echo $m1id; ?>'; a1id=''; o1id='<?php echo $_POST['o1id']; ?>'; o2id='<?php echo $_POST['o2id']; ?>'; o3id='<?php echo $_POST['o3id']; ?>'; o4id='<?php echo $_POST['o4id']; ?>'; o5id='<?php echo $date_curent; ?>';
...
<img src="//ac.ebis.ne.jp/log.php?argument=4T5ZVtUs&ebisPageID=SP_entory_pre&ebisMember=&ebisAmount=&ebisOther1=&ebisOther2=&ebisOther3=&ebisOther4=&ebisOther5=" width="0" height="0">
</noscript>
<!-- EBiS tag end -->
<?php 
		endif;
...
<div class="look_title_page yellow clear">
  <div class="publish_job_page">
    <h3 class="form_title">30代エグゼクティブのあなたにハイクラスな転職を。</h3>
  </div>
</div>
...
<?php
$google_check="entry_pre_complete";
?>
<script type="text/javascript" language="javascript">
  /* <![CDATA[ */
  var yahoo_ydn_conv_io = "but68SgOLDVw89tkLGbn";
  var yahoo_ydn_conv_label = "VGI2KQ2PSZIRU6ZDCXA295635";
...
<script type="text/javascript">
    ...
    var yahoo_conversion_label = "NLB1CJDu9W4Q26TTmQM";
...
<noscript>
<div style="display:inline;"> <img height="1" width="1" style="border-style:none;" alt="" src="//b91.yahoo.co.jp/pagead/conversion/1000377546/?value=0&label=NLB1CJDu9W4Q26TTmQM&guid=ON&script=0&disvt=true"/> </div>
</noscript>
