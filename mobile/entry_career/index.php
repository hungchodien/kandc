...
私たちが、あなたの良きパートナーとして転職活動をサポートいたします。</p>-->
        ...
        <div class="page1 bg_white content_inside block_content">
            ...
            <div class="group_txt_form clear" style="margin:0 0 20px 0;">
                <div class="clear title_txt">希望相談会<span class="notice"> (必須)</span></div>
                <div class="clear input_form">
                    <div class="input_100">

                        <div class="input_form clear">
                            <?php if(!empty($_POST)): $radio2_sl= $_POST['radio2']; endif; ?>
                           

                            <div class="input_100 check_radio_get">
                                <label for="radio3"><input id="radio3" type="radio" <?php if($radio2_sl=='「20代キャリア戦略の立て方」'):?> checked="checked" <?php endif; ?> value="「20代キャリア戦略の立て方」" name="radio2">「20代キャリア戦略の立て方」相談会</label>
                            </div>
            ...
            <div class="group_txt_form clear group_txt_form_select_fix">
                ...
                <div class="clear input_form">
                    ...
                    <div class="input_100 clear" style="margin-bottom:10px;">
                        <div class="input_40 l">
                            <select onfocus="click_text(this.id)" name="select15" id="select15" class="selection">
                                <?php echo $date1; ?>
                            </select>
                        </div>
                        <div class="input_20 l">
                            <select onfocus="click_text(this.id)" name="select16" id="select16" class="selection bg-text">
                                <?php echo $time1; ?>
                            </select>
                        </div>
                    ...
                    <div class="input_100 clear">
                        ...
                        <div class="input_40 l">
                            <select onfocus="click_text(this.id)" name="select17" id="select17" class="selection selection-style">
                                <?php echo $date2; ?>
                            </select>
                        </div>
                        <div class="input_20 l">
                            <select onfocus="click_text(this.id)" name="select18" id="select18" class="selection">
                                <?php echo $time1; ?>
                            </select>
                        </div>
                        <div class="input_width_52 l">スタート</div>
                ...
                <div class="clear input_form">
                    <div class="input_100">
                        <input id="text23" type="text"  value="<?php if(!empty($_POST)): echo $_POST['text23']; endif; ?>" name="text23" />
                    </div>
                </div>
            </div><!--End Group txt-->
				...
				jQuery(document).ready(function ($) {
                    ...
                    <div class="select_show3 clear" style="margin:5px 0;">
                                ...
                                <div class="clear" style="float: none;">
                                    <select class="selection" style="width: 300px" name="select19" id="select19" onfocus="click_text(this.id)">
                                        <option value="">下記から選択してください</option>
            ...
            <div class="group_txt_form clear">
                ...
                <div class="clear input_form">
                    <div class="input_100 clear confirm_txt_submit">
                        第1希望  <?php echo $_POST['select15']; ?> <?php echo $_POST['select16']; ?>  スタート
                    </div>
                    <div class="input_100 clear confirm_txt_submit">
                        第2希望  <?php echo $_POST['select17']; ?> <?php echo $_POST['select18']; ?> スタート
                    </div>
                    <div class="input_100 clear confirm_txt_submit">
