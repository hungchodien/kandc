...
function check_fileupload(fileName) {
 ...
 jQuery(document).ready(function ($) {
		 ...
		 //$("#submit_form").removeClass("textError");
            ...
            if($('input:radio[name=radio2]').is(':checked')===false)
            {
                $('#errorradio23').text($error_select);
                $('#errorradio23').addClass('error');
                $(this).find('input:radio[name=radio2]').addClass('textError');
                $(this).find('.check_radio_get').addClass('textError');
                $re17 = false;
            }
            else
            {
                $re17 = true;
                $("#errorradio23").empty();
                $(this).find('input:radio[name=radio2]').removeClass('textError');
                $(this).find('.check_radio_get').removeClass('textError');
            }
	...
	if($('#select1 option:selected').val() == '' && $('#select2 option:selected').val() == '' && $('#select3 option:selected').val() == '' )
		...
		else
		{
           ...
           if ($('#text18').val() == '') {
			...
			if ($re1 == false || $re2 == false || $re3 == false || $re4 == false || $re5 == false || $re6 == false || $re7 == false || $re9 == false  || $re12 == false || $re13 == false || $re14 == false || $re15 == false || $re16 == false || $re17 == false || $re18 == false || $re19 == false || $re20 == false)
			{
				scroll_top_id();
                return false;
            }
