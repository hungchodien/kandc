...
///// xoas entry : if (folder == 'entry' || folder == 'lp-entry' || folder == 'entry_fb' || folder=='lp-entry-form') {
if ( folder == 'lp-entry' || folder == 'entry_fb' ) {
    ...
    $(document).ready(function () {
        $('#submit_form').on('submit', function (){
            ...
            if ($('#text1_note').val() == '') {
                $('#errortext1_note').text($errorText);
                $('#errortext1_note').addClass('error');
                $(this).find('#text1_note').addClass('textError');
                $re6 = false;
            } else {
                $re6 = true;
            }
...
else if (folder == 'questionnaire' || folder == 'questionnaire-interview') {
    $(document).ready(function(){
        $('#submit_form').on('submit', function(){
