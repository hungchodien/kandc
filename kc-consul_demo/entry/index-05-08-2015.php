		 	...
		 	//	$entry_id_company=$_GET['entry_id'];
				...
				if($_GET['entry_id']==1019611):
					...
					if(!empty($company_name)):
						...
						$List_consultant = Get_Data("consultant", " and `consultant_Status`=0 and `consultant_entry_id`='$entry_id_company' order by `consultant_Date` DESC limit 1","`consultant_Name`");
