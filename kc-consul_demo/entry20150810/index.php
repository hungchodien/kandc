...
<head>
    ...
    <title>相談する |戦略コンサル、ITコンサル、ポストコンサル転職のクライス&amp;カンパニー</title>
...
<div id="page_category_name" class="clear">
    <div class="title-page">
        <p class="title-top">今後のキャリア、転職についてお考えのあなた</p>
        <p class="sub-title-top">私たちが、あなたの良きパートナーとして転職活動をサポートいたします。<br />※ご経験、ご希望によってはサポートが難しい場合もございますのでご了承ください。</p><p style="padding-top:5px; font-size:13px; float:right;">レジュメを添付してお申込みされたい方は<a href="<?php echo url_root; ?>entry_easy/?entry_id=1014585" target="_blank">こちら</a></p>
    </div>
</div>
